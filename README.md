...
* [microsoft/ClearScript](https://github.com/microsoft/ClearScript) - A library for adding scripting to .NET applications on Windows. Supports JavaScript (via V8 and JScript) and VBScript.
...
* [colyseus/colyseus-unity3d](https://github.com/colyseus/colyseus-unity3d) - ⚔ Multiplayer Game Client for Unity
