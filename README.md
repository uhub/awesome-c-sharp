...
* [asadsahi/AspNetCoreSpa](https://github.com/asadsahi/AspNetCoreSpa) - Asp.Net Core 2 & Angular (5+) SPA with Angular CLI, Webpack full featured application. Live demo:
...
* [anydream/il2cpp](https://github.com/anydream/il2cpp) - A MSIL/C# to C++ converter. Less memory, fast speed than CoreCLR
...
* [xljiulang/WebApiClient](https://github.com/xljiulang/WebApiClient) - 基于HttpClient，只需要定义http-api的接口(interface)，并打上相关特性，即可异步调用http-api的框架
