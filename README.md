...
* [rafaelfgx/Architecture](https://github.com/rafaelfgx/Architecture) - Architecture using .NET Core 3.1, ASP.NET Core 3.1, Entity Framework Core 3.1, C#, Angular 9.1, Clean Code, SOLID, DDD, Code Analysis, Docker and more.
...
* [openiddict/openiddict-core](https://github.com/openiddict/openiddict-core) - Versatile OpenID Connect stack for ASP.NET Core 2.1/3.1/5.0 and OWIN/Katana 4.1 (ASP.NET 4.x)
...
* [Tyrrrz/CliWrap](https://github.com/Tyrrrz/CliWrap) - Library for executing and piping shell commands
...
* [dotnetGame/MineCase](https://github.com/dotnetGame/MineCase) - A distributed minecraft server based on Orleans
...
* [Cinchoo/ChoETL](https://github.com/Cinchoo/ChoETL) - ETL Framework for .NET / c# (Parser / Writer for CSV, Flat, Xml, JSON, Key-Value, Parquet formatted files)
...
* [mariusmuntean/ChartJs.Blazor](https://github.com/mariusmuntean/ChartJs.Blazor) - Brings ChartJs charts to Blazor
