...
* [mattkol/Chromely](https://github.com/mattkol/Chromely) - Lightweight Alternative to Electron for .NET/.NET Core HTML5 Desktop Apps
...
* [tonerdo/coverlet](https://github.com/tonerdo/coverlet) - Cross platform code coverage tool for .NET Core
...
* [asadsahi/AspNetCoreSpa](https://github.com/asadsahi/AspNetCoreSpa) - Asp.Net Core 2.1 & Angular 7 SPA Fullstack application with plenty of examples. Live demo:
...
* [vietnam-devs/coolstore-microservices](https://github.com/vietnam-devs/coolstore-microservices) - :ferris_wheel: :sailboat: :ship: A containerized polyglot service mesh based on .NET Core, Nodejs, Blazor and more running on Istio
...
* [jamesmh/coravel](https://github.com/jamesmh/coravel) - .Net Core Framework For Indie Developers
...
* [dathlin/HslCommunication](https://github.com/dathlin/HslCommunication) - 一个工业物联网的底层架构框架，专注于底层的技术通信及跨平台，跨语言通信功能，实现各种主流的PLC数据读写，实现modbus的各种协议读写等等，支持快速搭建工业上位机软件，组态软件，SCADA软件，工厂MES系统，助力企业工业4.0腾飞，实现智能制造，智慧工厂的目标。
...
* [sebas77/Svelto.ECS](https://github.com/sebas77/Svelto.ECS) - Svelto ECS - C# Lightweight Data Oriented Entity Component System
...
* [aspnet/HttpClientFactory](https://github.com/aspnet/HttpClientFactory) - Contains an opinionated factory for creating HttpClient instances.
...
* [Microsoft/vsts-dotnet-samples](https://github.com/Microsoft/vsts-dotnet-samples) - C# samples that show integration with Visual Studio Team Services and Team Foundation Server
...
* [security-code-scan/security-code-scan](https://github.com/security-code-scan/security-code-scan) - Static code analyzer for .NET
