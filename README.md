...
* [mayuki/Cocona](https://github.com/mayuki/Cocona) - Micro-framework for .NET console application. Cocona makes it easy and fast to build console applications on .NET Core.
...
* [zhontai/Admin.Core](https://github.com/zhontai/Admin.Core) - Admin后端，前后端分离的权限管理系统，集成统一认证授权，支持国内外主流数据库自由切换和动态高级查询，基于.Net跨平台开发的WebApi
...
* [beto-rodriguez/LiveCharts2](https://github.com/beto-rodriguez/LiveCharts2) - Simple, flexible, interactive & powerful charts, maps and gauges for .Net, LiveCharts2 can now practically run everywhere WPF, Xamarin, Avalonia, Uno (WIP), WinForms and UWP (WIP).
