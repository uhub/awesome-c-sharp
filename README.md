...
* [anjoy8/Blog.Core](https://github.com/anjoy8/Blog.Core) - ASP.NET Core 2.2/3.1 教程，前后端分离的后端接口，vue教程的姊妹篇
...
* [Coldairarrow/Colder.Admin.AntdVue](https://github.com/Coldairarrow/Colder.Admin.AntdVue) - Admin Fx Based On .NET Core3.0 + Ant Design Vue
...
* [swharden/Csharp-Data-Visualization](https://github.com/swharden/Csharp-Data-Visualization) - A collection of minimal-case example projects which display data with Visual Studio
...
* [SciSharp/Pandas.NET](https://github.com/SciSharp/Pandas.NET) - Pandas port in C#, data analysis tool.
