...
* [siteserver/cms](https://github.com/siteserver/cms) - SiteServer CMS 基于.NET平台，能够以最低的成本、最少的人力投入在最短的时间内架设一个功能齐全、性能优异、规模庞大并易于维护的网站平台。
...
* [tonerdo/coverlet](https://github.com/tonerdo/coverlet) - Cross platform code coverage for .NET
* [anjoy8/Blog.Core](https://github.com/anjoy8/Blog.Core) - 🌈🌟🦉ASP.NET Core 3.1 全家桶教程，前后端分离后端接口，vue教程姊妹篇，官方文档
...
* [crest-ocean/crest](https://github.com/crest-ocean/crest) - An advanced ocean system implemented in Unity3D
...
* [rafaelfgx/Architecture](https://github.com/rafaelfgx/Architecture) - Architecture with .NET Core 3.1, ASP.NET Core 3.1, Entity Framework Core 3.1, C#, Angular 9, Clean Code, SOLID, DDD, Code Analysis, Docker and more.
...
* [vietnam-devs/coolstore-microservices](https://github.com/vietnam-devs/coolstore-microservices) - A Kubernetes-based microservices application on service mesh
...
* [dotnet/command-line-api](https://github.com/dotnet/command-line-api) - System.CommandLine: Command line parsing, invocation, and rendering of terminal output.
* [filipw/dotnet-script](https://github.com/filipw/dotnet-script) - Run C# scripts from the .NET CLI.
* [ivanpaulovich/clean-architecture-manga](https://github.com/ivanpaulovich/clean-architecture-manga) -  :cyclone: Clean Architecture with .NET Core 3.1 and C# 8. Use cases as central organizing structure, completely testable, decoupled from frameworks
...
* [SciSharp/TensorFlow.NET](https://github.com/SciSharp/TensorFlow.NET) - .NET Standard bindings for Google's TensorFlow for developing, training and deploying Machine Learning models in C#.
...
* [asadsahi/AspNetCoreSpa](https://github.com/asadsahi/AspNetCoreSpa) - Asp.Net Core 3.1 & Angular 8 SPA Fullstack application with plenty of examples. Live demo:
...
* [openiddict/openiddict-core](https://github.com/openiddict/openiddict-core) - Versatile OpenID Connect stack for ASP.NET 4.x and ASP.NET Core 2.x/3.x
...
* [yimengfan/BDFramework.Core](https://github.com/yimengfan/BDFramework.Core) - [中]Simple! Easy! Beautiful!  This‘s a powerful Unity3d game workflow! Unity3d framework：c# hotfix、asset manager、ui workflow、network debug... and so on
...
* [nilaoda/N_m3u8DL-CLI](https://github.com/nilaoda/N_m3u8DL-CLI) - [.NET] m3u8 downloader 开源的命令行m3u8/HLS下载器，支持AES-128解密，多线程，断点续传，自定义请求头等.
...
* [PiranhaCMS/piranha.core](https://github.com/PiranhaCMS/piranha.core) - Piranha.Core is the current version of Piranha CMS, completely rewritten for NetStandard & ASP.NET Core.
...
* [SadConsole/SadConsole](https://github.com/SadConsole/SadConsole) - A .NET ascii/ansi console engine written in C# for MonoGame and XNA. Create your own text roguelike (or other) games!
...
* [cyq1162/cyqdata](https://github.com/cyq1162/cyqdata) - cyq.data is a  high-performance and the most powerful orm.（.NET 最好用的ORM数据层框架，木有之一！支持.NET Core）Support：Txt、Xml、Access、Sqlite、Mssql、Mysql、Oracle、Sybase、Postgres、Redis、MemCache。
...
* [Davidobot/BetterJoyForCemu](https://github.com/Davidobot/BetterJoyForCemu) - Allows the Nintendo Switch Pro Controller, Joycons and SNES controller to be used with the Cemu Emulator and System-Wide
...
* [JasonGT/CleanArchitecture](https://github.com/JasonGT/CleanArchitecture) - Clean Architecture Solution Template for Angular 8 and .NET Core 3.1
* [dotnet/project-system](https://github.com/dotnet/project-system) - The C#, F# and Visual Basic project system for Visual Studio
* [sjh37/EntityFramework-Reverse-POCO-Code-First-Generator](https://github.com/sjh37/EntityFramework-Reverse-POCO-Code-First-Generator) - EntityFramework Reverse POCO Code First Generator - Beautifully generated code that is fully customisable. This generator creates code as if you reverse engineered a database and lovingly created the code by hand. Obtain your licence from
...
* [UiPath/corewf](https://github.com/UiPath/corewf) - WF runtime ported to work on .NET Core
...
* [cocowolf/loxodon-framework](https://github.com/cocowolf/loxodon-framework) - A mvvm framework for game development on the Unity3D,which supports lua and C# language.
...
* [microsoft/Xaml-Controls-Gallery](https://github.com/microsoft/Xaml-Controls-Gallery) - This app demonstrates the controls available in the Fluent Design System and Xaml.
...
* [abbyy/ocrsdk.com](https://github.com/abbyy/ocrsdk.com) - ABBYY Cloud OCR SDK
...
* [Coldairarrow/Colder.Admin.AntdVue](https://github.com/Coldairarrow/Colder.Admin.AntdVue) - Admin Fx Based On .NET Core3.1 + Ant Design Vue
...
* [oskardudycz/EventSourcing.NetCore](https://github.com/oskardudycz/EventSourcing.NetCore) - Example of Event Sourcing in .NET Core
...
* [arviedelgado/roro](https://github.com/arviedelgado/roro) - roro is a free, open-source robotic process automation software written in c#, wpf and .net core 3.0
* [DSharpPlus/DSharpPlus](https://github.com/DSharpPlus/DSharpPlus) - A C# library for making bots using the Discord API. (.NET framework)
...
* [dotnetcore/CanalSharp](https://github.com/dotnetcore/CanalSharp) -  Alibaba mysql database binlog incremental subscription & consumer components Canal's .NET client. 阿里巴巴mysql数据库binlog的增量订阅&消费组件 Canal 的 .NET 客户端
...
* [ccnet/CruiseControl.NET](https://github.com/ccnet/CruiseControl.NET) - CruiseControl.NET is an Automated Continuous Integration server, implemented using the .NET Framework. Downloads at sourceforge. The documentation can be found at:
...
* [weixinbao/WeChatXY](https://github.com/weixinbao/WeChatXY) - 最新微信ipad_7.04_V5协议，功能完善、稳定不易掉线。可以测试demo或api接口。请联系qq：1919670042
...
* [anjoy8/ChristDDD](https://github.com/anjoy8/ChristDDD) - ASP.NET Core 2.2 应用, 包含 DDD、CQRS、EDA 和事件回溯
...
* [tinohager/Nager.Date](https://github.com/tinohager/Nager.Date) - C# Worldwide public holiday calculation. Please star (★) this project!
...
* [mj1856/TimeZoneConverter](https://github.com/mj1856/TimeZoneConverter) - Lightweight libraries to convert between IANA, Windows, Rails, and POSIX time zones.
...
* [Kooboo/CMS](https://github.com/Kooboo/CMS) - The OLD Kooboo CMS source code
...
* [benjamin-hodgson/Pidgin](https://github.com/benjamin-hodgson/Pidgin) - C#'s fastest parser combinator library, developed at Stack Overflow.
...
* [abbaye/WpfHexEditorControl](https://github.com/abbaye/WpfHexEditorControl) - Wpf Hexeditor is a fast and fully customisable user control for editing file or stream as hexadecimal.  Can be used in Wpf or WinForm application
* [PredatH0r/ChanSort](https://github.com/PredatH0r/ChanSort) - TV channel list editor for Samsung, LG, Panasonic, Sony, Hisense, Philips, ITT/Medion/Nabo/ok/PEAQ/Schaub-Lorenz/Silva-Schneider/Telefunken, Toshiba, VDR
...
* [bchavez/RethinkDb.Driver](https://github.com/bchavez/RethinkDb.Driver) - :headphones: A NoSQL C#/.NET RethinkDB database driver with 100% ReQL API coverage.
* [mvelazc0/defcon27_csharp_workshop](https://github.com/mvelazc0/defcon27_csharp_workshop) - Writing custom backdoor payloads with C# - Defcon 27
...
* [Sergio0694/ComputeSharp](https://github.com/Sergio0694/ComputeSharp) - A .NET Standard 2.1 library to run C# code in parallel on the GPU through DX12 and dynamically generated HLSL compute shaders
...
* [gemgin/WeChatTools](https://github.com/gemgin/WeChatTools) - 微信域名检测接口:实时检测域名能否在微信中直接访问的技术;QQ管家域名检测接口;域名icp备案信息查询接口
...
* [Clancey/Comet](https://github.com/Clancey/Comet) - Comet is an MVU UIToolkit written in C#
* [atata-framework/atata](https://github.com/atata-framework/atata) - C#/.NET test automation framework for web
...
* [Sandrem/FlyCasual](https://github.com/Sandrem/FlyCasual) - Fan-made "Star Wars: X-Wing Miniatures Game" simulator
* [zeromq/clrzmq](https://github.com/zeromq/clrzmq) - CLR (.NET & Mono) binding for 0MQ
* [kwonganding/wpf.controls](https://github.com/kwonganding/wpf.controls) - 在学习中和使用WPF中，学习、借鉴了很多网友的文章和开源的项目的知识。发现提供实际项目开发需要的基础控件、样式的文章大都比较散，不成系列。因此基于现在项目中使用开发了一个wpf基础UI库，并写了这个系列入门文章（http://www.cnblogs.com/anding/p/5018363.html），希望对有需要的人有所帮助。
...
* [cloudscribe/cloudscribe.SimpleContent](https://github.com/cloudscribe/cloudscribe.SimpleContent) - A simple, yet flexible content and blog engine for ASP.NET Core that can work with or without a database, supports markdown or html editing
...
* [Coldairarrow/Colder.Fx.Net.AdminLTE](https://github.com/Coldairarrow/Colder.Fx.Net.AdminLTE) - A Web Rapid Development Framework For .NET4.472 Based On AdminLTE
...
* [Elfocrash/Cosmonaut](https://github.com/Elfocrash/Cosmonaut) - 🌐 A supercharged Azure CosmosDB .NET SDK with ORM support
...
* [ashleydavis/Fluent-Behaviour-Tree](https://github.com/ashleydavis/Fluent-Behaviour-Tree) - C# behaviour tree library with a fluent API
* [mono/ngit](https://github.com/mono/ngit) - Automated jgit port to c#
* [Kevin-Robertson/InveighZero](https://github.com/Kevin-Robertson/InveighZero) - Windows C# LLMNR/mDNS/NBNS/DNS spoofer/man-in-the-middle tool
...
* [winddyhe/knight](https://github.com/winddyhe/knight) - Knight is a game framework based on Unity3D engine. It includes a complete assetbundle manager, a c# hotfix module based on ILRuntime, and a UI module based on MVVM, and other basic functions support.
* [Unity-Technologies/animation-jobs-samples](https://github.com/Unity-Technologies/animation-jobs-samples) - Code samples using the animation C# jobs feature.
...
* [ixre/cms](https://github.com/ixre/cms) - DDD 开源.NET CMS、跨平台支持Docker容器
...
* [MachinaCore/CygwinPortable](https://github.com/MachinaCore/CygwinPortable) -  Portable Cygwin
...
* [sharpenrocks/Sharpen](https://github.com/sharpenrocks/Sharpen) - Visual Studio extension that intelligently introduces new C# features into your existing code base
...
* [aloneguid/config](https://github.com/aloneguid/config) - ⚙ Config.Net - the easiest configuration framework for .NET developers
...
* [thecodrr/BreadPlayer](https://github.com/thecodrr/BreadPlayer) - Bread Player, a free and open source music player powered by UWP and C#/.NET with a sleek and polished design built for, and by, the people seeking a better alternative to Groove and Windows Media Player by Microsoft.
...
* [mdabros/SharpLearning](https://github.com/mdabros/SharpLearning) - Machine learning for C# .Net
...
* [NonFactors/AspNetCore.Grid](https://github.com/NonFactors/AspNetCore.Grid) - Grid controls for ASP.NET Core projects
...
* [Cinchoo/ChoETL](https://github.com/Cinchoo/ChoETL) - ETL Framework for .NET (Parser / Writer for CSV, Flat, Xml, JSON, Key-Value formatted files)
* [Caphyon/clang-power-tools](https://github.com/Caphyon/clang-power-tools) - Bringing clang-tidy magic to Visual Studio C++ developers.
* [MaKiPL/OpenVIII](https://github.com/MaKiPL/OpenVIII) - Open source VIII engine implementation in C# working on Windows and Linux (Android and iOS planned too!)
...
* [aliyun/aliyun-oss-csharp-sdk](https://github.com/aliyun/aliyun-oss-csharp-sdk) - Aliyun OSS SDK for C#
...
* [microsoft/ConferenceVision](https://github.com/microsoft/ConferenceVision) - Sample Xamarin.Forms Phone App showed in Microsoft Build 2018
...
* [takuya-takeuchi/DlibDotNet](https://github.com/takuya-takeuchi/DlibDotNet) - Dlib .NET wrapper written in C++ and C# for Windows, MacOS and Linux
...
* [AndreiMisiukevich/ContextMenu](https://github.com/AndreiMisiukevich/ContextMenu) - ContextViewCell for Xamarin.Forms 🇧🇾
* [VincentH-Net/CSharpForMarkup](https://github.com/VincentH-Net/CSharpForMarkup) - Use declarative style C# instead of XAML for Xamarin Forms UI
...
* [tylike/CIIP](https://github.com/tylike/CIIP) - CIIP用于快速开发ERP类信息系统的框架.由CIIP.Designer(业务模型设计器)和CIIP.Client客户端运行程序组成.包含报表设计器，Dashboard数据分析工具，支持验证规则，支持外观变化规则，内置权限模块，界面布局设计器，多国语言支持，支持14种常用数据库，如SqlServer，Oracle，MySql等。
...
* [Chris3606/GoRogue](https://github.com/Chris3606/GoRogue) - .NET Standard roguelike library in C#.  Features many algorithms and data structures pertinent to roguelike/2D game developers, specifically designed to be minimally intrusive upon the developer's architecture.
* [axodox/AxoCover](https://github.com/axodox/AxoCover) - Nice and free .Net code coverage support for Visual Studio with OpenCover.
...
* [NewLifeX/NewLife.Cube](https://github.com/NewLifeX/NewLife.Cube) - 魔方是一个基于 ASP.NET MVC 的 用户权限管理平台，可作为各种信息管理系统的基础框架。
...
* [IdentityModel/IdentityModel.OidcClient](https://github.com/IdentityModel/IdentityModel.OidcClient) - Certified C#/NetStandard OpenID Connect Client Library for native mobile/desktop Applications (RFC 8252)
...
* [iccb1013/Sheng.Winform.Controls](https://github.com/iccb1013/Sheng.Winform.Controls) - 升讯威 .Net WinForm 控件库提供了超过15种 Winform 控件，你可以直接使用本控件库，更可以通过本控件库学到 Winform 控件开发的方法和理念。
* [BlueshiftSoftware/EntityFrameworkCore](https://github.com/BlueshiftSoftware/EntityFrameworkCore) - NoSQL providers for EntityFramework Core
* [ddevault/Craft.Net](https://github.com/ddevault/Craft.Net) - (Unmaintained, see TrueCraft) Minecraft server, client, and etc for .NET
...
* [TheM4hd1/Vayne-RaT](https://github.com/TheM4hd1/Vayne-RaT) - An Advanced C# .NET Rat, It’s Stable and Contains Many Features.
* [SciSharp/Keras.NET](https://github.com/SciSharp/Keras.NET) - Keras.NET is a high-level neural networks API, written in C# with Python Binding and capable of running on top of TensorFlow, CNTK, or Theano.
...
* [Auburns/FastNoise_CSharp](https://github.com/Auburns/FastNoise_CSharp) - FastNoise C# Version
...
* [elanderson/Angular-Core-IdentityServer](https://github.com/elanderson/Angular-Core-IdentityServer) - Using Angular (4+) with ASP.NET Core and IdentityServer4
...
* [ROBOTIS-GIT/DynamixelSDK](https://github.com/ROBOTIS-GIT/DynamixelSDK) - ROBOTIS Dynamixel SDK (Protocol1.0/2.0)
...
* [komefai/PS4Macro](https://github.com/komefai/PS4Macro) - Automation utility for PS4 Remote Play written in C#
...
* [hiramtan/HiSocket](https://github.com/hiramtan/HiSocket) - It is a lightweight client socket solution, you can used it in C# project or Unity3d
...
* [dathlin/HslCommunication](https://github.com/dathlin/HslCommunication) - I chose bread between open source and bread. I chose bread. Since I opened it in 2017, I have harvested 1300+ stars and helped a large number of people to develop a lot of software. But the actual donation is very small, so much so that I can't afford a loan for the house. So from August 2019, no longer open source, turn to the subscription model, thank you for your understanding.
* [Viagi/LandlordsCore](https://github.com/Viagi/LandlordsCore) - ET斗地主Demo，ET开源链接：https://github.com/egametang/ET
* [uxmal/pytocs](https://github.com/uxmal/pytocs) - Converts Python source to C#
* [DamonMohammadbagher/NativePayload_DNS](https://github.com/DamonMohammadbagher/NativePayload_DNS) - C# code for Transferring Backdoor Payloads by DNS Traffic and Bypassing Anti-viruses
* [Coldairarrow/Coldairarrow.Fx.Core.Easyui.GitHub](https://github.com/Coldairarrow/Coldairarrow.Fx.Core.Easyui.GitHub) - A Web Rapid Development Framework For .NET Core
...
* [lolp1/Process.NET](https://github.com/lolp1/Process.NET) - A C# class library for interacting with processes.
...
* [unity3d-jp/UnityChanSpringBone](https://github.com/unity3d-jp/UnityChanSpringBone) - UnityChan Sping Bone System for lightweight secondary animations
...
* [GameBuildingBlocks/UnityComponent](https://github.com/GameBuildingBlocks/UnityComponent) - Unity Resource Component
...
* [qinyuanpei/HttpServer](https://github.com/qinyuanpei/HttpServer) - 一个使用C#编写的简易Web服务器
...
* [twitchdev/chat-samples](https://github.com/twitchdev/chat-samples) - This repository contains samples illustrating how to interact with Twitch Chat.
...
* [MonoMod/MonoMod](https://github.com/MonoMod/MonoMod) - A C# modding swiss army knife, powered by cecil.
...
* [microfisher/Strong-Web-Crawler](https://github.com/microfisher/Strong-Web-Crawler) - 基于C#.NET+PhantomJS+Sellenium的高级网络爬虫程序。可执行Javascript代码、触发各类事件、操纵页面Dom结构。
...
* [Lanesra712/Grapefruit.VuCore](https://github.com/Lanesra712/Grapefruit.VuCore) - A front-background project using ASP.NET Core WebApi and Vue.js
* [googlearchive/google-api-dotnet-client-samples](https://github.com/googlearchive/google-api-dotnet-client-samples) - Samples of using the Google APIs Client Library for .NET
...
* [CatLib/CatLib](https://github.com/CatLib/CatLib) - CatLib for unity3d dependency injection framework
* [CatImmortal/Trinity](https://github.com/CatImmortal/Trinity) - 基于Unity的纯C#（客户端+服务端+热更新）游戏开发整合方案
...
* [AlturosDestinations/Alturos.Yolo](https://github.com/AlturosDestinations/Alturos.Yolo) - C# Yolo Darknet Wrapper (real-time object detection)
...
* [swharden/Csharp-Data-Visualization](https://github.com/swharden/Csharp-Data-Visualization) - A collection of minimal-case example projects which display data using C#
* [pixeltris/USharp](https://github.com/pixeltris/USharp) - C# plugin for Unreal Engine 4
* [Tlgyt/The-Collection](https://github.com/Tlgyt/The-Collection) - Collection of cracked malware, and ebooks
...
* [djkaty/Il2CppInspector](https://github.com/djkaty/Il2CppInspector) - The easy way to extract types and metadata from Unity IL2CPP binaries
...
* [VulcanTechnologies/HoloLensCameraStream](https://github.com/VulcanTechnologies/HoloLensCameraStream) - This Unity plugin makes the HoloLens video camera frames available to a Unity app in real time. This enables Unity devs to easily use the HoloLens camera for computer vision (or anything they want).
...
* [ObjectivityLtd/Ocaramba](https://github.com/ObjectivityLtd/Ocaramba) - C# Framework to automate tests using Selenium WebDriver
* [mixandjam/Celeste-Movement](https://github.com/mixandjam/Celeste-Movement) - Recreating the movement and feel from Celeste
* [keijiro/ContactShadows](https://github.com/keijiro/ContactShadows) - Experimental implementation of contact shadows for Unity.
...
* [5argon/protobuf-unity](https://github.com/5argon/protobuf-unity) - Automatic .proto files compilation in Unity project to C# as you edit them, plus utilities.
...
* [parallelbgls/Modbus.Net](https://github.com/parallelbgls/Modbus.Net) - A high extensible hardware communication platform using C#
* [nxrighthere/ValveSockets-CSharp](https://github.com/nxrighthere/ValveSockets-CSharp) - Managed C# wrapper for GameNetworkingSockets library by Valve Software
* [mganss/XmlSchemaClassGenerator](https://github.com/mganss/XmlSchemaClassGenerator) - Generate C# classes from XML Schema files
* [keijiro/OscJack](https://github.com/keijiro/OscJack) - Lightweight implementation of OSC server/client in C# (Unity)
...
* [ddevault/ChatSharp](https://github.com/ddevault/ChatSharp) - Sane IRC library for .NET
...
* [mattatz/CellularGrowth](https://github.com/mattatz/CellularGrowth) - GPU-based cellular growth simulation in Unity. 🧠
...
* [ccccccmd/ReCapcha](https://github.com/ccccccmd/ReCapcha) - 验证码识别  发票标号识别  图片识别
* [LordMike/TMDbLib](https://github.com/LordMike/TMDbLib) - C#.Net library for TheMovieDB.
* [LayoutFarm/Typography](https://github.com/LayoutFarm/Typography) - C# Font Reader (TrueType / OpenType / OpenFont / CFF / woff / woff2) , Glyphs Layout and Rendering
...
* [yukuyoulei/ILRuntime_HotGames](https://github.com/yukuyoulei/ILRuntime_HotGames) - 基于ILRuntime的热更新能力实现的可以直接使用的框架，友情赠送C# WebService + WebSocketServer服务器端。
...
* [SciSharp/Pandas.NET](https://github.com/SciSharp/Pandas.NET) - Pandas port in C#, data analysis tool, process multi-dim array in DataFrame.
...
* [bytefish/TinyCsvParser](https://github.com/bytefish/TinyCsvParser) - Easy to use, easy to extend and high-performance library for CSV parsing with .NET
...
* [CraneInForest/LockStepSimpleFramework-Client](https://github.com/CraneInForest/LockStepSimpleFramework-Client) - unity帧同步游戏极简框架-客户端
...
* [sipsorcery/sipsorcery](https://github.com/sipsorcery/sipsorcery) - A cross platform C# .NET library for SIP and RTP.
...
* [aspnet/EntityFrameworkCore](https://github.com/aspnet/EntityFrameworkCore) - EF Core is a modern object-database mapper for .NET. It supports LINQ queries, change tracking, updates, and schema migrations.
* [rafaelfgx/DotNetCoreArchitecture](https://github.com/rafaelfgx/DotNetCoreArchitecture) - Architecture with .NET Core 3, ASP.NET Core 3, Entity Framework Core 3, C#, Angular 8, Clean Code, SOLID, DDD, Code Analysis, Docker and more.
* [ChilliCream/hotchocolate](https://github.com/ChilliCream/hotchocolate) - Hot Chocolate is a GraphQL server, written in C# for .Net Core and .Net Framework
...
* [Cysharp/MicroBatchFramework](https://github.com/Cysharp/MicroBatchFramework) - Cloud Native Batch Framework for C# to building CLI tools/Daemon/Batch.
...
* [pharan/Unity-MeshSaver](https://github.com/pharan/Unity-MeshSaver) - A C# Editor Script that allows you to save a usable Mesh .asset file into your project.
* [dreling8/Nop.Framework](https://github.com/dreling8/Nop.Framework) - c# asp.net mvc  base development framework from nopCommerce。
* [planetarium/libplanet](https://github.com/planetarium/libplanet) - Blockchain core in C#/.NET for persistent peer-to-peer online games
* [JeffreySu/WxOpen](https://github.com/JeffreySu/WxOpen) - 微信小程序 C# SDK，Senparc.Weixin.WxOpen.dll
* [easy66/MonoHooker](https://github.com/easy66/MonoHooker) - hook C# method at runtime without modify dll file (such as UnityEditor.dll)
...
* [microsoft/BotBuilder-CognitiveServices](https://github.com/microsoft/BotBuilder-CognitiveServices) - The Microsoft Cognitive Services controls for Microsoft Bot Builder
...
* [DalSoft/DalSoft.RestClient](https://github.com/DalSoft/DalSoft.RestClient) - The C# REST Client - the only REST/ HTTP Client you will ever need
* [graphql-dotnet/conventions](https://github.com/graphql-dotnet/conventions) - GraphQL Conventions Library for .NET
* [geaz/sharpDox](https://github.com/geaz/sharpDox) - A c# documentation tool (Discontinued)
...
* [TheAllenChou/unity-cj-lib](https://github.com/TheAllenChou/unity-cj-lib) - Utility library for Unity
...
* [aspnetboilerplate/aspnet-core-template](https://github.com/aspnetboilerplate/aspnet-core-template) - ASP.NET Core & EntityFramework Core Based Startup Template
...
* [microsoft/Cognitive-Face-Windows](https://github.com/microsoft/Cognitive-Face-Windows) - Windows SDK for the Microsoft Face API, part of Cognitive Services
...
* [XiaoFaye/WooCommerce.NET](https://github.com/XiaoFaye/WooCommerce.NET) - A .NET Wrapper for WooCommerce/WordPress REST API
...
* [firesharkstudios/butterfly-server-dotnet](https://github.com/firesharkstudios/butterfly-server-dotnet) - The Everything is Real-Time C# Backend for Web and Desktop Apps
...
* [proletariatgames/CUDLR](https://github.com/proletariatgames/CUDLR) - ⛔️ [DEPRECATED] Console for Unity Debugging and Logging Remotely
...
* [Unity-Technologies/LWRP-CustomRendererExamples](https://github.com/Unity-Technologies/LWRP-CustomRendererExamples) - This project contains a collection of Custom Renderer examples. This will be updated as we refine the feature and add more options.
...
* [mwrlabs/SharpGPOAbuse](https://github.com/mwrlabs/SharpGPOAbuse) - SharpGPOAbuse is a .NET application written in C# that can be used to take advantage of a user's edit rights on a Group Policy Object (GPO) in order to compromise the objects that are controlled by that GPO.
...
* [coldicelion/Strong-Web-Crawler](https://github.com/coldicelion/Strong-Web-Crawler) - 基于C#.NET+PhantomJS+Sellenium的高级网络爬虫程序。可执行Javascript代码、触发各类事件、操纵页面Dom结构。
* [IdentityModel/IdentityModel.OidcClient2](https://github.com/IdentityModel/IdentityModel.OidcClient2) - Certified C#/NetStandard OpenID Connect Client Library for native mobile/desktop Applications
...
* [elcattivo/CloudFlareUtilities](https://github.com/elcattivo/CloudFlareUtilities) - A .NET Standard Library to bypass Cloudflare's Anti-DDoS measure (JavaScript challenge) using a DelegatingHandler.
...
* [xorrior/Random-CSharpTools](https://github.com/xorrior/Random-CSharpTools) - Collection of CSharp Assemblies focused on Post-Exploitation Capabilities
...
* [Akaion/Bleak](https://github.com/Akaion/Bleak) - A Windows native DLL injection library written in C# that supports several methods of injection.
* [Dandarawy/Unity3DBookPageCurl](https://github.com/Dandarawy/Unity3DBookPageCurl) - Page curl effect for Unity3D using UGUI
...
* [huwb/crest-oceanrender](https://github.com/huwb/crest-oceanrender) - An advanced ocean system implemented in Unity3D
* [k8gege/K8CScan](https://github.com/k8gege/K8CScan) - 大型内网渗透自定义插件化扫描器（附C#/VC/Delphi/Python插件Demo源码) 程序采用多线程批量扫描大型内网多个IP段C段主机，目前插件包含: C段旁注扫描、子域名扫描、Ftp密码爆破、Mysql密码爆、系统密码爆破、存活主机扫描、端口扫描、Web信息探测、操作系统版本探测、Cisco思科设备扫描等,支持调用任意外部程序或脚本
* [damienbod/AspNetCoreMultipleProject](https://github.com/damienbod/AspNetCoreMultipleProject) - ASP.NET Core MVC EF Core
...
* [dotMorten/DotNetOMDGenerator](https://github.com/dotMorten/DotNetOMDGenerator) - A Roslyn-based cross-platform tool that generates an object model diagram from a set of C# source files or assemblies
* [punker76/code-samples](https://github.com/punker76/code-samples) - Just some code samples...
...
* [Firwood-Software/AdvanceDLSupport](https://github.com/Firwood-Software/AdvanceDLSupport) - Delegate-based C# P/Invoke alternative - compatible with all platforms and runtimes.
...
* [praeclarum/CLanguage](https://github.com/praeclarum/CLanguage) - C parser, compiler, and interpreter for .NET
...
* [martin2250/OpenCNCPilot](https://github.com/martin2250/OpenCNCPilot) - autolevelling gcode-sender for grbl
...
* [MicrosoftArchive/cqrs-journey](https://github.com/MicrosoftArchive/cqrs-journey) - Microsoft patterns & pratices CQRS Journey sample application
* [OpenCQRS/OpenCQRS](https://github.com/OpenCQRS/OpenCQRS) - .NET Core framework for DDD, CQRS and Event Sourcing
* [flubu-core/flubu.core](https://github.com/flubu-core/flubu.core) - A cross platform build and deployment automation system for building projects and executing deployment scripts using C# code.
* [microsoft/AppCenter-SDK-DotNet](https://github.com/microsoft/AppCenter-SDK-DotNet) - Development repository for the App Center SDK for .NET platforms, including Xamarin
* [leosperry/Chroniton](https://github.com/leosperry/Chroniton) - A library for running tasks(jobs) on schedules.
* [influxdata/influxdb-csharp](https://github.com/influxdata/influxdb-csharp) - A .NET library for efficiently sending points to InfluxDB
...
* [Microsoft/WindowsCompositionSamples](https://github.com/Microsoft/WindowsCompositionSamples) - Windows Composition Samples the place for getting the latest code samples and demos using Windows.UI.Xaml and Windows.UI.Composition to make beautiful Universal Windows Platform applications.
* [Microsoft/clrmd](https://github.com/Microsoft/clrmd) - Microsoft.Diagnostics.Runtime is a set of APIs for introspecting processes and dumps.
* [springd5211/UnityCodes](https://github.com/springd5211/UnityCodes) - SpringGUI是对UGUI的拓展，提供十多种UI组件用于快速开发。
* [Microsoft/Cognitive-Samples-IntelligentKiosk](https://github.com/Microsoft/Cognitive-Samples-IntelligentKiosk) - Welcome to the Intelligent Kiosk Sample! Here you will find several demos showcasing workflows and experiences built on top of the Microsoft Cognitive Services.
* [Microsoft/CSharpClient-for-Kafka](https://github.com/Microsoft/CSharpClient-for-Kafka) - .Net implementation of the Apache Kafka Protocol that provides basic functionality through Producer/Consumer classes. The project also offers balanced consumer implementation.
* [Microsoft/MixedRealityCompanionKit](https://github.com/Microsoft/MixedRealityCompanionKit) - This is a MixedRealityToolkit style repository for code bits and components that may not run directly on Microsoft HoloLens or immersive headsets but instead pair with them to build experiences.
* [Microsoft/ClearScript](https://github.com/Microsoft/ClearScript) - A library for adding scripting to .NET applications. Supports JavaScript (via V8 and JScript) and VBScript.
...
* [Microsoft/ClangSharp](https://github.com/Microsoft/ClangSharp) - Clang bindings for .NET and Mono written in C#
* [Microsoft/azure-devops-dotnet-samples](https://github.com/Microsoft/azure-devops-dotnet-samples) - .NET/C# samples for integrating with Azure DevOps Services and Azure DevOps Server
* [Microsoft/ConferenceVision](https://github.com/Microsoft/ConferenceVision) - Sample Xamarin.Forms 3.0 Phone App showed in Microsoft Build 2018
* [Microsoft/BotBuilder-CognitiveServices](https://github.com/Microsoft/BotBuilder-CognitiveServices) - The Microsoft Cognitive Services controls for Microsoft Bot Builder
* [Microsoft/AppCenter-SDK-DotNet](https://github.com/Microsoft/AppCenter-SDK-DotNet) - Development repository for the App Center SDK for .NET platforms, including Xamarin
* [Microsoft/Xaml-Controls-Gallery](https://github.com/Microsoft/Xaml-Controls-Gallery) - This app demonstrates the controls available in the Fluent Design System and Xaml.
* [ObjectivityLtd/Test.Automation](https://github.com/ObjectivityLtd/Test.Automation) - C# Framework to automate tests using Selenium WebDriver
* [Microsoft/slow-cheetah](https://github.com/Microsoft/slow-cheetah) - Tooling for XML and JSON file transforms on build from Visual Studio and MSBuild
* [Microsoft/VS-ColorThemes](https://github.com/Microsoft/VS-ColorThemes) - Visual Studio Extension that installs additional color themes
* [Microsoft/Cognitive-Face-Windows](https://github.com/Microsoft/Cognitive-Face-Windows) - Windows SDK for the Microsoft Face API, part of Cognitive Services
...
* [Smart-Kit/SmartCode](https://github.com/Smart-Kit/SmartCode) - SmartCode = IDataSource -> IBuildTask -> IOutput => Build Everything!!!
* [deepakkumar1984/SiaNet](https://github.com/deepakkumar1984/SiaNet) - A C# deep learning library, human friendly, CUDA/OpenCL supported, well structured, easy to extend
...
* [unruledboy/WuManber](https://github.com/unruledboy/WuManber) - WuManber text search/matching implementation using c#
...
* [CanalClient/CanalSharp](https://github.com/CanalClient/CanalSharp) -  Alibaba mysql database binlog incremental subscription & consumer components Canal's .NET client[阿里巴巴mysql数据库binlog的增量订阅&消费组件 Canal 的 .NET 客户端 ]   https://github.com/alibaba/canal
* [Microsoft/vsts-dotnet-samples](https://github.com/Microsoft/vsts-dotnet-samples) - C# samples that show integration with Azure DevOps and Team Foundation Server
* [dmetzgar/corewf](https://github.com/dmetzgar/corewf) - WF runtime ported to work on .NET Core
* [TigerHix/Cytoid](https://github.com/TigerHix/Cytoid) - A community-driven touchscreen music game.
* [zone117x/cryptonote-easy-miner](https://github.com/zone117x/cryptonote-easy-miner) - cryptonote easy miner
...
* [mariuszkerl/AspNetCoreSubdomain](https://github.com/mariuszkerl/AspNetCoreSubdomain) - Simple usage lib for subdomain routing in ASP.NET Core/Framework MVC
...
* [dotnetcore/BotSharp](https://github.com/dotnetcore/BotSharp) - The Open Source AI Chatbot Platform Builder in 100% C# Running in .NET Core with Machine Learning algorithm.
...
* [SciSharp/NumSharp](https://github.com/SciSharp/NumSharp) - NumPy + SciPy port in C#, translate Python Machine Learning code in One - One function mapping.
* [jsix/cms](https://github.com/jsix/cms) - DDD 开源.NET CMS、跨平台支持Docker容器
...
* [Speedygeek/ZendeskApi_v2](https://github.com/Speedygeek/ZendeskApi_v2) - C# wrapper for the Zendesk API
...
* [MikePopoloski/SharpBgfx](https://github.com/MikePopoloski/SharpBgfx) - C# bindings for the bgfx graphics library
* [SeriaWei/ZKEACMS.Core](https://github.com/SeriaWei/ZKEACMS.Core) - ZKEACMS for .Net Core (.Net Core CMS)可视化设计在线编辑内容管理系统
* [Ahoo-Wang/SmartCode](https://github.com/Ahoo-Wang/SmartCode) - SmartCode = IDataSource -> IBuildTask -> IOutput => Build Everything!!!
* [Awesome-CMS-Core/Awesome-CMS-Core](https://github.com/Awesome-CMS-Core/Awesome-CMS-Core) - Awesome CMS Core is an open source CMS built using ASP.Net Core & ReactJS with module seperation concern in mind and provide lastest trend of technology like .Net Core, React, Webpack, SASS, Background Job, Message Queue.
...
* [mrjono1/FastExcel](https://github.com/mrjono1/FastExcel) - Fast Excel Reading C# and Fast Excel Writing C#
...
* [ll4080333/UnityCodes](https://github.com/ll4080333/UnityCodes) - SpringGUI是对UGUI的拓展，提供十多种UI组件用于快速开发。
* [52ABP/LTMCompanyNameFree.YoyoCmsTemplate](https://github.com/52ABP/LTMCompanyNameFree.YoyoCmsTemplate) - 一个免费版本的ABP框架，整合了ng-Zorro。
...
* [XamFormsExtended/Xfx.Controls](https://github.com/XamFormsExtended/Xfx.Controls) - Xamarin Forms Extended Controls
...
* [rafaelfgx/DotNetArchitecture](https://github.com/rafaelfgx/DotNetArchitecture) - Architecture cross-platform with .NET Core 2.1, ASP.NET Core 2.1, Entity Framework Core 2.1, C#, Angular 7, DDD, SOLID, Code Analysis, Docker and others best practices and technologies.
...
* [jasonpang/Interceptor](https://github.com/jasonpang/Interceptor) - C# wrapper for a Windows keyboard driver. Can simulate keystrokes and mouse clicks in protected areas like the Windows logon screen (and yes, even in games). Wrapping http://oblita.com/Interception
...
* [Oceania2018/BotSharp](https://github.com/Oceania2018/BotSharp) - The Open Source AI Chatbot Platform Builder in 100% C# Running in .NET Core
* [aspnet/Common](https://github.com/aspnet/Common) - A repository for shared files to be consumed across the ASPNET repos
* [lengseling/DesignPattern](https://github.com/lengseling/DesignPattern) - This is my case in learning design patterns using C#
* [CanalSharp/CanalSharp](https://github.com/CanalSharp/CanalSharp) -  Alibaba mysql database binlog incremental subscription & consumer components Canal's .NET client[阿里巴巴mysql数据库binlog的增量订阅&消费组件 Canal 的 .NET 客户端 ]   https://github.com/alibaba/canal
...
* [mehtadone/CryptoGramBot](https://github.com/mehtadone/CryptoGramBot) - A simple telegram bot that sends your balance updates from coinigy, send trade notifications from Poloniex and Bittrex and creates you a trade export for your own spreadsheet magicary.
...
* [UnknownShadow200/ClassicalSharp](https://github.com/UnknownShadow200/ClassicalSharp) - Custom Minecraft Classic / ClassiCube client written in C# (soon to be C) from scratch.
* [crhairr/EntityFrameworkCore.MongoDb](https://github.com/crhairr/EntityFrameworkCore.MongoDb) - EntityFrameworkCore MongoDb Provider
* [andrewnakas/ARKit-Cardboard-VR](https://github.com/andrewnakas/ARKit-Cardboard-VR) - ARkit + GVR to make VR and Mixed Reality 6dof AR for iphone
...
* [sgjsakura/AspNetCore](https://github.com/sgjsakura/AspNetCore) - ASP.NET Core Extension Library
...
* [huoshan12345/WebQQWeChat](https://github.com/huoshan12345/WebQQWeChat) - webQQ和web微信相关协议的.net实现
* [step-up-labs/firebase-authentication-dotnet](https://github.com/step-up-labs/firebase-authentication-dotnet) - C# library for Firebase Authentication
...
* [JKorf/Bittrex.Net](https://github.com/JKorf/Bittrex.Net) - A C# .Net wrapper for the Bittrex web API including all features easily accessible and usable
...
* [blakeohare/crayon](https://github.com/blakeohare/crayon) - Crayon Programming Language
* [AzureCAT-GSI/DevCamp](https://github.com/AzureCAT-GSI/DevCamp) - Contains content for the Azure DevCamp
...
* [MikeCodesDotNet/My-StepCounter](https://github.com/MikeCodesDotNet/My-StepCounter) - Xamarin iOS & Android Starter pedometer sample
* [chkr1011/Wirehome.Core](https://github.com/chkr1011/Wirehome.Core) - Open Source Home Automation system for .NET
...
* [emersonsoares/cep-api](https://github.com/emersonsoares/cep-api) - 💩 API para desenvolvedores utilizarem em aplicações que precisem encontrar um endereço a partir do CEP informado.
...
* [costajob/app-servers](https://github.com/costajob/app-servers) - App Servers benchmarked for: Ruby, Python, JavaScript, Dart, Elixir, Java, Clojure, Scala, C#, Crystal, Nim, C, D, GO, Rust
* [ClockGet/AutoCopy](https://github.com/ClockGet/AutoCopy) - A automatic object-object copyer
* [onovotny/BouncyCastle-PCL](https://github.com/onovotny/BouncyCastle-PCL) - This version is deprecated. Please use my other repo for the latest https://github.com/onovotny/bc-csharp
...
* [Mapsui/Mapsui](https://github.com/Mapsui/Mapsui) - Mapsui is C# Map component for WPF, Xamarin.Android, Xamarin.iOS and UWP apps
* [lengseling/Sweep-the-code-to-pay](https://github.com/lengseling/Sweep-the-code-to-pay) - Use the.net scan code payment interface case.
...
* [TyrenDe/SSHServer](https://github.com/TyrenDe/SSHServer) - This is a tutorial on how to build a basic SSH Server in C#, but you are welcome to try following in any language.
...
* [xljiulang/WebApiClient](https://github.com/xljiulang/WebApiClient) - 一款基于HttpClient封装，只需要定义c#接口并修饰相关特性，即可异步调用远程http接口的客户端库
* [TelegramBots/telegram.bot.examples](https://github.com/TelegramBots/telegram.bot.examples) - A few Examples for the Telegram.Bot C# Library
...
* [ekkash/WebCrunch](https://github.com/ekkash/WebCrunch) - Search the web for videos, audios, eBooks, torrents, subtitles, archives and much more
...
* [stulzq/Alipay.AopSdk.Core](https://github.com/stulzq/Alipay.AopSdk.Core) - 支付宝（Alipay）服务端SDK AopSdk，修改自官方最新版本：113。采用.NET Standard 2.0，支持.NET Core 2.0，与官方SDK接口完全相同。完全可以按照官方文档进行开发。不仅仅支持支付，官方SDK支持的功能本SDK全部支持用法几乎一样。
...
* [KN4CK3R/ReClass.NET](https://github.com/KN4CK3R/ReClass.NET) - Not just a ReClass port to the .NET platform.
...
* [bradyholt/aspnet-core-react-template](https://github.com/bradyholt/aspnet-core-react-template) - ASP.NET Core 2.0 / React SPA Template App
...
* [Xavr0k/ChaperoneTweak](https://github.com/Xavr0k/ChaperoneTweak) - An in-VR chaperone editor
...
* [Weapsy/CMS](https://github.com/Weapsy/CMS) - ASP.NET Core CMS
...
* [gpailler/MegaApiClient](https://github.com/gpailler/MegaApiClient) - C# library to access Mega.co.nz
...
* [alexandrnikitin/CircuitBreaker.Net](https://github.com/alexandrnikitin/CircuitBreaker.Net) - Circuit Breaker pattern for .NET
