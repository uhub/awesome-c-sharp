...
* [umbraco/Umbraco-CMS](https://github.com/umbraco/Umbraco-CMS) - The simple, flexible and friendly ASP.NET CMS used by more than 350.000 websites
...
* [JeffreySu/WeiXinMPSDK](https://github.com/JeffreySu/WeiXinMPSDK) - 微信公众平台SDK Senparc.Weixin for C#，支持.NET Framework及.NET Core。已支持微信公众号、企业号、开放平台、微信支付、JSSDK。
* [SirCmpwn/TrueCraft](https://github.com/SirCmpwn/TrueCraft) - Minecraft for hipsters
* [JimBobSquarePants/ImageProcessor](https://github.com/JimBobSquarePants/ImageProcessor) - :camera: A cross-platform library for processing of image files written in C#
...
* [npgsql/npgsql](https://github.com/npgsql/npgsql) - Npgsql is the .NET data provider for PostgreSQL. It allows any program developed for .NET framework to access a PostgreSQL database server. It is implemented in 100% C# code. PostgreSQL versions since 9.1 are officially supported, others may work.
...
* [aalhour/C-Sharp-Algorithms](https://github.com/aalhour/C-Sharp-Algorithms) - Implementations of Data Structures and Algorithms in C#
...
* [beto-rodriguez/Live-Charts](https://github.com/beto-rodriguez/Live-Charts) - Animated, MVVM friendly .Net charts, for WPF, WinForms under MIT Licence (Free), written in C#, LiveCharts listens for any change in your data automatically and updates UI. http://lvcharts.net/
...
* [MarcelloLins/GooglePlayAppsCrawler](https://github.com/MarcelloLins/GooglePlayAppsCrawler) - Read the ReadMe :D
...
* [Microsoft/Mobius](https://github.com/Microsoft/Mobius) - C# language binding and extensions to Apache Spark
...
* [koczkatamas/CVE-2016-0051](https://github.com/koczkatamas/CVE-2016-0051) - BSoD PoC for CVE-2016-0051 (MS-016)
...
* [rabbitmq/rabbitmq-dotnet-client](https://github.com/rabbitmq/rabbitmq-dotnet-client) - RabbitMQ .NET client
...
* [aspnet/cli-samples](https://github.com/aspnet/cli-samples) - ASP.NET Core and the CLI working together in harmony
...
* [mgravell/capnproto-net](https://github.com/mgravell/capnproto-net) - Cap'n Proto bindings for .NET languages
...
* [guryanovev/CrystalQuartz](https://github.com/guryanovev/CrystalQuartz) - a lightweight, completely pluggable module for displaying Quartz.NET scheduler jobs information
* [daveaglick/Scripty](https://github.com/daveaglick/Scripty) - Tools to let you use Roslyn-powered C# scripts for code generation
* [praeclarum/Continuous](https://github.com/praeclarum/Continuous) - Continuous and live coding environment for iOS apps
...
* [Belphemur/SoundSwitch](https://github.com/Belphemur/SoundSwitch) - C# application to switch default playing device. Download: https://www.aaflalo.me/downloads/
...
* [sochix/TLSharp](https://github.com/sochix/TLSharp) - Telegram (http://telegram.org) client library implemented in C#. Waiting for contributors!
...
* [linvi/tweetinvi](https://github.com/linvi/tweetinvi) - Tweetinvi is an intuitive .NET C# library to access the Twitter REST and STREAM API. It is a Portable Class Library that can be used for development on Windows, Windows RT, Windows Phone, Mono, Xamarin Android and Xamarin iOS. Tweetinvi is also compatible with Universal App.
...
* [mxgmn/ConvChain](https://github.com/mxgmn/ConvChain) - Procedural level generation from examples. Inspired by convnets and MCMC.
...
* [SirCmpwn/ChatSharp](https://github.com/SirCmpwn/ChatSharp) - The sane IRC library
...
* [jacobdufault/forge](https://github.com/jacobdufault/forge) - C# libraries aimed at simplifying game development targeting .NET >=3.5
...
* [yevhen/Nake](https://github.com/yevhen/Nake) - Magic script-based C# task runner. C# V6 is supported!
...
* [sebas77/Lightweight-IoC-Container-for-Unity3D](https://github.com/sebas77/Lightweight-IoC-Container-for-Unity3D) - Lightweight IoC Container for Unity3D
* [kerryjiang/SuperSocket.ClientEngine](https://github.com/kerryjiang/SuperSocket.ClientEngine) - A .NET socket client library
...
* [mrsheepuk/ASPNETSelfCreatedTokenAuthExample](https://github.com/mrsheepuk/ASPNETSelfCreatedTokenAuthExample) - Example of how to protect an ASP.NET 5 / MVC 6 (beta 8) API using simple self-created JWT bearer tokens.
...
* [sjh37/EntityFramework-Reverse-POCO-Code-First-Generator](https://github.com/sjh37/EntityFramework-Reverse-POCO-Code-First-Generator) - Beautifully generated code first code that is fully customisable.
...
* [LukeTillman/killrvideo-csharp](https://github.com/LukeTillman/killrvideo-csharp) - Video sharing web application using Cassandra, .NET, and Azure
...
* [trentsartain/Neural-Network](https://github.com/trentsartain/Neural-Network) - This is my configurable Neural Network written in C#.  The Network functionality is completely decoupled from the UI and can be ported to any project.
...
* [RedpointGames/Protogame](https://github.com/RedpointGames/Protogame) - Protogame is an open source game engine (MIT licensed) written on top of MonoGame and C#, designed to allow game developers to rapidly produce games within 48 hours.
...
* [MarcelloLins/Apple-Store-Crawler](https://github.com/MarcelloLins/Apple-Store-Crawler) - A simple, scalable scrapper for apps data being listed on Apple's AppStore
...
* [signumsoftware/framework](https://github.com/signumsoftware/framework) - Open Source framework from Signum Software for writing data-centric applications over the latest Microsoft technologies: .Net 4.0, C# 4.0, WPF, ASP.Net MVC 3.0, Razor
...
* [cyq1162/cyqdata](https://github.com/cyq1162/cyqdata) - cyq.data is not only a orm,but also a data access layer,it's very special and diffirent from others,who use who love it.
...
* [MvvmCross/MvvmCross-Forms](https://github.com/MvvmCross/MvvmCross-Forms) - Support for Xamarin.Forms on MvvmCross: The .NET MVVM framework for cross-platform solutions, including Xamarin.iOS, Xamarin.Android, Windows and Mac.
...
* [ziyasal/Caliburn.Metro](https://github.com/ziyasal/Caliburn.Metro) - Library combines MahApps.Metro with Caliburn.Micro for Metro UI styled WPF applications.
...
* [gaochundong/Cowboy](https://github.com/gaochundong/Cowboy) - Cowboy is a library for building sockets based services.
...
* [hhblaze/DBreeze](https://github.com/hhblaze/DBreeze) - C# .NET MONO NOSQL ( key value store ) ACID embedded database management system.
...
* [ErikEJ/SqlCeToolbox](https://github.com/ErikEJ/SqlCeToolbox) - SQL Server Compact & SQLite Toolbox extension for Visual Studio
...
* [pauldendulk/Mapsui](https://github.com/pauldendulk/Mapsui) - Mapsui is a C# library to create geographical maps for WPF, Xamarin.Android, Xamarin.iOS, WinRT and Windows Phone
...
* [solarwinds/OrionSDK](https://github.com/solarwinds/OrionSDK) - SDK for the SolarWinds Orion platform, including tools, documentation, and samples in PowerShell, C#, Python, and Java.
...
* [ControlzEx/ControlzEx](https://github.com/ControlzEx/ControlzEx) - Shared Controlz for WPF and...
...
* [softwaretirol/MonoDebugger](https://github.com/softwaretirol/MonoDebugger) - Visual Studio Extension for debugging .NET/C# Monoapplications
...
* [ChevyRay/QuadTree](https://github.com/ChevyRay/QuadTree) - A C# QuadTree implementation specifically designed for testing AABB collisions in 2D space.
...
* [MvvmCross/MvvmCross-Plugins](https://github.com/MvvmCross/MvvmCross-Plugins) - Plugins for MvvmCross: The .NET MVVM framework for cross-platform solutions.
* [MvvmCross/MvvmCross-AndroidSupport](https://github.com/MvvmCross/MvvmCross-AndroidSupport) - Android support library packages for MvvmCross: The .NET MVVM framework for cross-platform solutions.
...
* [mortennobel/UnityUtils](https://github.com/mortennobel/UnityUtils) - A library of C# utility classes for the Unity 3.x and 4.x
* [joelpurra/xmouse-controls](https://github.com/joelpurra/xmouse-controls) - A tool for Windows 7/2008/8 to enable or disable active window tracking, raising and also the delay in milliseconds. This is known as x-mouse behavior.
...
* [UnknownShadow200/ClassicalSharp](https://github.com/UnknownShadow200/ClassicalSharp) - Custom Minecraft Classic client written in C# from scratch.
...
* [HangfireIO/Hangfire](https://github.com/HangfireIO/Hangfire) - An easy way to perform fire-and-forget, delayed and recurring tasks inside ASP.NET apps
...
* [aspnetboilerplate/aspnetboilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate) - ASP.NET Boilerplate - Framework
...
* [Azure/azure-sdk-for-net](https://github.com/Azure/azure-sdk-for-net) - Microsoft Azure SDK for .NET
...
* [danielcrenna/metrics-net](https://github.com/danielcrenna/metrics-net) - Capturing CLR and application-level metrics. So you know what's going on.
...
* [bridgedotnet/Bridge](https://github.com/bridgedotnet/Bridge) - Write modern mobile and web apps in C#. Run them anywhere in JavaScript with Bridge.NET.
...
* [jstedfast/MimeKit](https://github.com/jstedfast/MimeKit) - A cross-platform .NET MIME creation and parser library with support for S/MIME, PGP, DKIM, TNEF and Unix mbox spools.
...
* [rebus-org/Rebus](https://github.com/rebus-org/Rebus) - :bus: Rebus is a lean service bus implementation for .NET, similar in nature to NServiceBus and MassTransit, only leaner.
...
* [apache/log4net](https://github.com/apache/log4net) - Mirror of Apache log4net
...
* [jwt-dotnet/jwt](https://github.com/jwt-dotnet/jwt) - JWT (JSON Web Token) implementation for .NET 3.5+ (Public Domain)
...
* [yeahwu/firefox-xx](https://github.com/yeahwu/firefox-xx) - Integrated into xx-net
...
* [sdrapkin/SecurityDriven.Inferno](https://github.com/sdrapkin/SecurityDriven.Inferno) - .NET crypto done right.
...
* [ziyasal/FireSharp](https://github.com/ziyasal/FireSharp) - .Net client library for Firebase REST API
...
* [elmerbulthuis/jshtml](https://github.com/elmerbulthuis/jshtml) - Clean HTML, full JavaScript (sjs) template engine. Inspired by the razor view engine used in asp.net mvc.
...
* [ProgTrade/nUpdate](https://github.com/ProgTrade/nUpdate) - An easy update solution for .NET-applications.
...
* [IrcDotNet/IrcDotNet](https://github.com/IrcDotNet/IrcDotNet) - IRC.NET is a complete IRC (Internet Relay Chat) client library for the .NET Framework 4.0 and Silverlight 4.0. It aims to provide a complete and efficient implementation of the protocol as described in RFCs 1459 and 2812, as well as de-facto modern features of the protocol.  The .NET Framework version of the library is also intended to compile and run under Mono 2.6 and later. Note: this branches hosted here are clones of the official branches hosted on Launchpad.
...
* [srpurdy/SharpEdgeCMS](https://github.com/srpurdy/SharpEdgeCMS) - Content Management System
* [abock/CurlSharp](https://github.com/abock/CurlSharp) - A modern C# (5.0/async) binding against libcurl with System.Net.Http support
* [wmeyer/SharpCGI](https://github.com/wmeyer/SharpCGI) - A F# FastCGI library for .NET  (also for C#, VB.NET and other .NET languages)
* [netonjm/ChipmunkSharp](https://github.com/netonjm/ChipmunkSharp) - Advanced physics engine library based on Chipmunk in C# created for CocosSharp
* [cferdinandi/image-compress-and-sharpen](https://github.com/cferdinandi/image-compress-and-sharpen) - Change the default WordPress compression rate for JPGs, convert images to progressive JPGs, and sharpen images.
* [masroore/CurlSharp](https://github.com/masroore/CurlSharp) - CurlSharp - .Net binding and object-oriented wrapper for libcurl.
* [jcrisp/simple_rest_client_c_sharp](https://github.com/jcrisp/simple_rest_client_c_sharp) - A basic REST client in C#. Allows you to set the verb, request body and see the status code and all the headers on the response.
* [SimonRichards/clang-sharp](https://github.com/SimonRichards/clang-sharp) - OO C# bindings for libclang
* [thefactory/Chromecast-Sharp](https://github.com/thefactory/Chromecast-Sharp) - Hold all the Chromecast C# wrappers and example code.
* [KyleGobel/MarkdownSharp-GithubCodeBlocks](https://github.com/KyleGobel/MarkdownSharp-GithubCodeBlocks) - Markdown sharp edited to support github code blocks
* [tutsplus/SOLID-Design-Principles-in-C-Sharp](https://github.com/tutsplus/SOLID-Design-Principles-in-C-Sharp) - Source Code for the Tuts+ Course: Solid Design Patterns in C#
* [Litipk/ColorSharp](https://github.com/Litipk/ColorSharp) - A .NET/Mono library to handle color spaces (and light spectrums!)
* [thespooler/ffmpeg-shard](https://github.com/thespooler/ffmpeg-shard) - Fork of ffmpeg-sharp (http://code.google.com/p/ffmpeg-sharp/) C# bindings to ffmpeg to keep up with new ffmpeg API
* [rzhw/CloudAppSharp](https://github.com/rzhw/CloudAppSharp) - Wrapper for the CloudApp v1 API
* [patriklindstrom/HelloWorld-Rhino-ETL](https://github.com/patriklindstrom/HelloWorld-Rhino-ETL) - Simple examples of Rhino ETL the C Sharp ETL library
* [gaillard/SharpCover](https://github.com/gaillard/SharpCover) - C# code coverage tool with Linux (Mono) and Windows (.NET 4.0) support.
* [MortenHoustonLudvigsen/CommonMarkSharp](https://github.com/MortenHoustonLudvigsen/CommonMarkSharp) - A CommonMark parser for .Net
* [richardspiers/C-Sharp-Sip-Lib](https://github.com/richardspiers/C-Sharp-Sip-Lib) - SIP Library written in C#
* [ipfans/Manzana](https://github.com/ipfans/Manzana) - Manzana C Sharp Library
* [nathanpjones/randomColorSharped](https://github.com/nathanpjones/randomColorSharped) - Port of David Merfield's javascript random color generator. Ported by Nathan Jones.
* [cunkai/Unity-CSV-To-C-Sharp](https://github.com/cunkai/Unity-CSV-To-C-Sharp) - Unity CSV转为C#文件 来省去解析csv的步骤，节省游戏加载时间。
* [DavidBenko/MHTML-to-HTML-Decoding-in-C-Sharp](https://github.com/DavidBenko/MHTML-to-HTML-Decoding-in-C-Sharp) - Converts MHTML to HTML
* [wolfspelz/ConfigSharp](https://github.com/wolfspelz/ConfigSharp) - Configure your .NET application with C# config files. Config files are C# source files: intellisensed, refactorable, resharpered, syntax checked, compiled, type safe. Write real code with control structures and classes in config files. Include other config files and remote (HTTP) config snippets.
* [indieteq/Eloquent-C-sharp-MySQL-Database-Class](https://github.com/indieteq/Eloquent-C-sharp-MySQL-Database-Class) - A C# MySQL database class which is inspired by the Eloquent ORM of the Laravel Framework
* [Programming-Algorithms-Book/C-Sharp-Translation-Sources](https://github.com/Programming-Algorithms-Book/C-Sharp-Translation-Sources) - C# Translation of "Programming =++ Algorithms;" book
* [sledwith/PGP-Decryption-With-C-Sharp](https://github.com/sledwith/PGP-Decryption-With-C-Sharp) - Example .Net application that decrypts a PGP encrypted file using the Bouncy Castle library in C Sharp
* [raywenderlich/c-sharp-style-guide](https://github.com/raywenderlich/c-sharp-style-guide) - C# Style Guide for Unity Tutorials
* [boussena/Sharp-Miner](https://github.com/boussena/Sharp-Miner) - Sharp Miner is an open source c# scrypt miner
* [ajlopez/ClojSharp](https://github.com/ajlopez/ClojSharp) - A Clojure interpreter written in C#, Work in Progress.
* [TinkerWorX/SharpCraft](https://github.com/TinkerWorX/SharpCraft) - SharpCraft is a library that helps modding Warcraft III: The Frozen Throne.
* [xoofx/SharpCppGen](https://github.com/xoofx/SharpCppGen) - An executable tool to generate pure C# code interop from C/C++ header files
* [photo/openphoto-c-sharp](https://github.com/photo/openphoto-c-sharp) - A C# library for OpenPhoto
* [paulfryer/CacheSharp](https://github.com/paulfryer/CacheSharp) - A Task based .Net distributed cache abstraction layer for Memcached, Redis, SQL Server. Includes a plugin model for others too.
* [grupy-net-it/Akademia-C-Sharp](https://github.com/grupy-net-it/Akademia-C-Sharp) - Kod źródłowy zaprezentowany podczas serii Akademia C# na spotkaniach PUT .NET
* [dotMorten/SharpGIS.HttpClient.WP](https://github.com/dotMorten/SharpGIS.HttpClient.WP) - HttpClient for Windows Phone
* [conceptdev/TDBadgedCellSharp](https://github.com/conceptdev/TDBadgedCellSharp) - MonoTouch/c# port of Tim Davies' TDBadgedCell iPhone project
* [cefsharp/CefSharp.Tutorial](https://github.com/cefsharp/CefSharp.Tutorial) - CefSharp Tutorials - Basic Examples for getting Started
* [benburkhart1/sharp-aquos-remote-control](https://github.com/benburkhart1/sharp-aquos-remote-control) - This projects attempts to give the user the ability to control their Sharp Aquos Television from a Node.JS project.
* [robertream/PostSharp.NotifyPropertyChanged](https://github.com/robertream/PostSharp.NotifyPropertyChanged) - auto-magic INotifyPropertyChanged done right
* [rasmuskl/ReSharperCourse](https://github.com/rasmuskl/ReSharperCourse) - ReSharper workshop material
* [panterlo/v1s.GoogleVisualization](https://github.com/panterlo/v1s.GoogleVisualization) - C#, C Sharp, Class Library to support all the aspects of the Google Visualization API including support for MVC
* [mafiya69/SharpChat](https://github.com/mafiya69/SharpChat) - A Simple Chat Program.
* [laurentkempe/TeamCitySharper](https://github.com/laurentkempe/TeamCitySharper) - .NET 4 library to access TeamCity REST API in both Async and Sync ways
* [jpepiot/SharpCast](https://github.com/jpepiot/SharpCast) - SharpCast is a C# implementation of the Google ChromeCast V2 protocol.
* [headdetect/SharpCrush](https://github.com/headdetect/SharpCrush) - A .NET Wrapper for the media crush API. https://mediacru.sh/docs/API
* [gicmo/csharpxcode](https://github.com/gicmo/csharpxcode) - C# Plugin for Xcode 3 based on cocoa-sharp-dev's Xcode plugin
* [fuxuejun/SharpSnippetCompiler-v5](https://github.com/fuxuejun/SharpSnippetCompiler-v5) - SharpSnippetCompiler with SharpDevelop v5.0
* [Sohojoe/CocosSharp-Forms-sample](https://github.com/Sohojoe/CocosSharp-Forms-sample) - Createing a sample project which has both CocosSharp and Xamarin Forms in the same project
* [upyun/c-sharp-sdk](https://github.com/upyun/c-sharp-sdk) - UPYUN C-Sharp SDK
* [stuartcarnie/sharp-c64](https://github.com/stuartcarnie/sharp-c64) - Port of the Frodo Commodore 64 emulator to C#
* [songsharp/MovieClipSharp](https://github.com/songsharp/MovieClipSharp) - Egret MovieClip的加强版
* [rocklau/SqlBuilder](https://github.com/rocklau/SqlBuilder) - SqlBuilder for c sharp
* [namoshika/CookieGetterSharp](https://github.com/namoshika/CookieGetterSharp) - ブラウザのCookieを.NETアプリで使えるようにするライブラリ
* [mightyleader/CardSharp](https://github.com/mightyleader/CardSharp) - A blackjack game for iPhone, no UI yet, just game logic.
* [markbecker/WMI_Monitor_Csharp](https://github.com/markbecker/WMI_Monitor_Csharp) - A "System Monitor" project using "WMI" and "Open Hardware Monitor" in C-sharp
* [lkinsella/SharpCache](https://github.com/lkinsella/SharpCache) - A pluggable caching engine for .NET
* [gregko/TtsSetup_C_sharp](https://github.com/gregko/TtsSetup_C_sharp) - TtsSetup Xamarin C# example
* [colin-higgins/ChessSharp](https://github.com/colin-higgins/ChessSharp) - C# MVC chess application. Focus on User interface.
* [churchillyik/TravianTool](https://github.com/churchillyik/TravianTool) - a C Sharp project for Travian assistance
* [brechtlampaert/hello-world-template-touchatag-c-sharp](https://github.com/brechtlampaert/hello-world-template-touchatag-c-sharp) - A template used by the Touchatag service
* [boyd4y/sharpbuild](https://github.com/boyd4y/sharpbuild) - Visual Studio extension to let c sharp build with a sharp speed
* [arccoza/redu](https://github.com/arccoza/redu) - A complete C# (C Sharp) redis client library.
* [Mervill/SharpCircuit](https://github.com/Mervill/SharpCircuit) - C# port of Paul Falstad's excellent circuit simulator applet.
* [Marc2009/C-Sharp-Chat-Programm](https://github.com/Marc2009/C-Sharp-Chat-Programm) - C# Chatprogramm
* [MakerDyne/Memory-LCD-for-Raspberry-Pi](https://github.com/MakerDyne/Memory-LCD-for-Raspberry-Pi) - Example Raspberry Pi C++ class/library for my Sharp Memory LCD Breakout Boards
* [Maghoumi/CarveSharp](https://github.com/Maghoumi/CarveSharp) - .NET Wrapper for Carve's CSG and mesh boolean operations
* [LiuJi-Jim/sharp-context](https://github.com/LiuJi-Jim/sharp-context) - Sharp Context is a C# implementation of Shape Context.
* [JohnLamontagne/CEngineSharp](https://github.com/JohnLamontagne/CEngineSharp) - A free, open-source 2D ORPG Engine written in C#.
* [JamieH/ColourSharp](https://github.com/JamieH/ColourSharp) - ColourSharp is something
* [JPedroMarques/SharpCalendar](https://github.com/JPedroMarques/SharpCalendar) - jQuery calendar pluggin.
* [Eun/CefSharp-Example](https://github.com/Eun/CefSharp-Example) - This is an preconfigured project to start right off using chromium in C#
* [sushihangover/CursesSharp](https://github.com/sushihangover/CursesSharp) - Curses Sharp is a curses terminal control library binding for C#.
* [pirrmann/PolymorphicEnum](https://github.com/pirrmann/PolymorphicEnum) - An implementation of a polymorphic enum, documented in several blog posts, starting with http://www.pirrmann.net/polymorphic-enums-in-c-sharp/
* [philjones88/SpreedlyCoreSharp](https://github.com/philjones88/SpreedlyCoreSharp) - SpreedlyCoreSharp - A C# Spreedly Client
* [damirkusar/C-Sharp-Design-Patterns](https://github.com/damirkusar/C-Sharp-Design-Patterns) - C# Design Patterns
* [asxinyu/Improved_SharpConfig](https://github.com/asxinyu/Improved_SharpConfig) - First
* [alt236/Barcode-Generator-C-Sharp](https://github.com/alt236/Barcode-Generator-C-Sharp) - Create barcodes either individually (one by one), or in bulk based on a script file.
* [adisD/Sharp-Architecture-Contrib](https://github.com/adisD/Sharp-Architecture-Contrib) - This is the contrib project for the S#arp Architecture framework.  This project provides additional functionality and alternative approaches to delivering solutions on S#arp projects.  Project led by Tom Cabanski.
* [abock/clutter-sharp](https://github.com/abock/clutter-sharp) - Fork of upstream clutter-sharp for 0.9 fixups, to be proposed back upstream when working
* [Metapyziks/SharpChem](https://github.com/Metapyziks/SharpChem) - I will totally abandon this project within a week.
* [GeoLearning/HR-WebServices-Examples-C-Sharp](https://github.com/GeoLearning/HR-WebServices-Examples-C-Sharp) - Example code for integrating with user creation / updating SOAP web services
* [GDProgramming/IRC-Sharp](https://github.com/GDProgramming/IRC-Sharp) - IRC-Sharp is an IRC client, powered by C#
* [Eltavo/PatronesDisenoC-Sharp](https://github.com/Eltavo/PatronesDisenoC-Sharp) - Patrones de diseño implementados en el lenguaje de programación C#
* [Concliff/Maze](https://github.com/Concliff/Maze) - C-Sharp Project. 2D Arcade game with static images as graphics.
* [3DHDSoft/consolex](https://github.com/3DHDSoft/consolex) - A library on top of Curses Sharp for C# which improves the API and usability significantly
* [windsurfer/C-Sharp-Multicast](https://github.com/windsurfer/C-Sharp-Multicast) - Sends and recieves files over multicast - send one file to many computers at once
* [wbennett/sharpy](https://github.com/wbennett/sharpy) - An online C-Sharp REPL
* [vim-scripts/sharp-Indent](https://github.com/vim-scripts/sharp-Indent) - Indent for C# (keywords: C-sharp, C sharp, CSharp)
* [utneon/Visual-Studio-C-Sharp-Academic-Project-2--Oriented-Object-Programming](https://github.com/utneon/Visual-Studio-C-Sharp-Academic-Project-2--Oriented-Object-Programming) - Visual C# Console Application - Skill Level: Beginner-Advanced on general programming and begginer on Oriented Object Programming. I developed this Visual Studio C# console application project for C# programming language course. The objective given was to simulate an application for bank account management using Oriented Object Programming.
* [urielzen/C_Sharp_Blog_Singleton_Full_App](https://github.com/urielzen/C_Sharp_Blog_Singleton_Full_App) - Blog created in Visual Studio to practice the basic elements of OOP.
* [timothyandrew/sublime-c-sharp-build-system](https://github.com/timothyandrew/sublime-c-sharp-build-system) - (very) Basic SL2 build system for C#.
* [sharparchitecture/sharparchitecture.github.com](https://github.com/sharparchitecture/sharparchitecture.github.com) - S#arp Architecture github pages
* [romxero/C_SHARP_Prime_Number_Bit_Array](https://github.com/romxero/C_SHARP_Prime_Number_Bit_Array) - Finding prime number using a bit array in C#
* [reuzel/CqlSharp.Linq](https://github.com/reuzel/CqlSharp.Linq) - Linq to CQL provider based on the CqlSharp ADO.Net Data Provider
* [naelstrof/2420-C-Sharp-Sorts-and-Data-Structures](https://github.com/naelstrof/2420-C-Sharp-Sorts-and-Data-Structures) - Homework Assignments
* [mxpv/Clang2Sharp](https://github.com/mxpv/Clang2Sharp) - C# bindings for clang library
* [mrbongiolo/exercicios-c-sharp](https://github.com/mrbongiolo/exercicios-c-sharp) - Exercício de C# - 3º Período
* [matthewp/canread-sharp](https://github.com/matthewp/canread-sharp) - Implementation of readability.js in C#
* [mattberther/sharp-editor](https://github.com/mattberther/sharp-editor) - C# Sharp Basic Editor to show usage of Command pattern
* [matjack1/yashp](https://github.com/matjack1/yashp) - Yet Another c-SHarp Profiler
* [lupine/sharp-coin](https://github.com/lupine/sharp-coin) - Alternative Bitcoin node that will support multiple use-cases
* [kjpou1/CocosSharpSteer](https://github.com/kjpou1/CocosSharpSteer) - CocosSharpSteer is a port of SharpSteer2 to work with CocosSharp
* [kahanu/iCalendarSharp](https://github.com/kahanu/iCalendarSharp) - A C# component for creating a simple vCalendar message that you can send along with emails from your web application.
* [jivkopetiov/MHTabBarControllerSharp](https://github.com/jivkopetiov/MHTabBarControllerSharp) - MonoTouch port of MHTabBarController
* [jithinputhiyattu/dreamFrameWork](https://github.com/jithinputhiyattu/dreamFrameWork) - Custom UI and database classes for C sharp .net programmers
* [jdindia/jp-and-meetri-learning-c-sharp](https://github.com/jdindia/jp-and-meetri-learning-c-sharp) - Obvious is obvious.
* [jakezhaojb/CPBD-sharpness](https://github.com/jakezhaojb/CPBD-sharpness) - The code is used to evaluate the shapeness of images.
* [j4jayant/hl7-cSharp-parser](https://github.com/j4jayant/hl7-cSharp-parser) - HL7 C# parser
* [hoganlong/Queue-ICPC-C-Sharp-Example](https://github.com/hoganlong/Queue-ICPC-C-Sharp-Example) - Example code from the Queue-ICPC Challenge fixed for 2.4
* [gogokaradjov/ExtendedCollectionsSharp](https://github.com/gogokaradjov/ExtendedCollectionsSharp) - ExtendedCollectionsSharp
* [fluxware/Fluxware-Game-Engine-C-Sharp](https://github.com/fluxware/Fluxware-Game-Engine-C-Sharp) - The Fluxware Game Engine ported to C#
* [fahminlb33/ReSharpedClam](https://github.com/fahminlb33/ReSharpedClam) - A tiny libclamav binding for .NET (C# and VB.NET).
* [emara-geek/Receive-data-from-PIC-or-Arduino-to-PC-using-C-Sharp](https://github.com/emara-geek/Receive-data-from-PIC-or-Arduino-to-PC-using-C-Sharp) - Receive data from PIC or Arduino to PC through Serial Port using C#
* [eissa4444/artificial-inteligence-voice-recognition](https://github.com/eissa4444/artificial-inteligence-voice-recognition) - voice recognition application built in c sharp
* [edmccaffrey/functional-c-sharp](https://github.com/edmccaffrey/functional-c-sharp) - Libraries and extensions for functional programming in C#
* [eddbc/GoogleChartSharp](https://github.com/eddbc/GoogleChartSharp) - A C# wrapper for the Google Chart Images API.
* [ebobwright/C-Sharp-Entity-System](https://github.com/ebobwright/C-Sharp-Entity-System) - A simple Entity System for XNA games.
* [dp9u0/Crawlers](https://github.com/dp9u0/Crawlers) - Crawlers By C Sharp
* [dimentox/c_sharp_teamspeak_plugin](https://github.com/dimentox/c_sharp_teamspeak_plugin) - Team speak plugin framework in c#
* [chergert/clutter-sharp](https://github.com/chergert/clutter-sharp) - Occasional clutter-sharp hackery
* [bvmake/Learn-C-Sharp-The-Hard-Easy-Way](https://github.com/bvmake/Learn-C-Sharp-The-Hard-Easy-Way) - Learn C# by doing (that is typing it into the keyboard)
* [bricas/sauce-sharp](https://github.com/bricas/sauce-sharp) - A C Sharp library to read, write and remove SAUCE records
* [blorgbeard/sharp-snippet-compiler](https://github.com/blorgbeard/sharp-snippet-compiler) - A small C# IDE, based on a sample project distributed with SharpDevelop v3.
* [benburkhart1/sharp-aquos-remote-control-test](https://github.com/benburkhart1/sharp-aquos-remote-control-test) - A test program showing off the capabilities and usage of the sharp aquos remote control.
* [bdb-opensource/c-sharp-pitfalls](https://github.com/bdb-opensource/c-sharp-pitfalls) - Document describing pitfalls and bugs in the C# language, compiler or .NET framework
* [YesserLab/CppSharp](https://github.com/YesserLab/CppSharp) - Expanding C++ with features from C#
* [WaniKani/C-Sharp-API-Client](https://github.com/WaniKani/C-Sharp-API-Client) - Translates the JSON API data into C# workable data.
* [Travelport/travelport-uapi-tutorial-c-sharp](https://github.com/Travelport/travelport-uapi-tutorial-c-sharp) - C# tutorial on how to consume UAPI Services
* [SurferNJ/tws-api-csharp-client](https://github.com/SurferNJ/tws-api-csharp-client) - Interactive Brokers Trader Workstation API Client in C Sharp
* [SaqibS/mygengo-csharp](https://github.com/SaqibS/mygengo-csharp) - A C-Sharp library to interface with the myGengo translation API.
* [RecognizeIm/C-sharp-client](https://github.com/RecognizeIm/C-sharp-client) - Recognize.im API client for C#
* [PramodDutta/Online-reservation-System-In-C-sharp--Asp.net](https://github.com/PramodDutta/Online-reservation-System-In-C-sharp--Asp.net) - Full Online  reservation System In C sharp ,Asp.net
* [PadreSJ/c101_Module4_C-Sharp-2](https://github.com/PadreSJ/c101_Module4_C-Sharp-2) - Module 4 of Coding 101
* [GreenCodeLab/Dirty_soft-C_Sharp](https://github.com/GreenCodeLab/Dirty_soft-C_Sharp) - Dirty soft and green patterns . Techno : C#, ASP.NET 4.0, SQL Server 2008 R2, T-SQL
* [GeoLearning/dataextract-c-sharp](https://github.com/GeoLearning/dataextract-c-sharp) - Example project that shows how to extract a file using C#
* [Edza/ChemSharp](https://github.com/Edza/ChemSharp) - A simple chemistry library for C#
* [DNNX/GoogleCodeJamSharpDevelopAddin](https://github.com/DNNX/GoogleCodeJamSharpDevelopAddin) - An Add-in for SharpDevelop containing template C# project for solution of Google Code Jam problems
* [Corvalius/alexa-awis-c-sharp](https://github.com/Corvalius/alexa-awis-c-sharp) - Basic, not refactored, buggy... but working sample of 4 main AWIS API Actions (UrlInfo, CategoryListings, CategoryBrowse, SitesLinkingIn)
* [CHECK24/c24.TeamSharper](https://github.com/CHECK24/c24.TeamSharper) - TeamSharper will help you managing and deploying team settings for ReSharper (v7+).
* [BrainForge/c_sharp_labs](https://github.com/BrainForge/c_sharp_labs) - лабы по си
* [Bloggify/c-sharp-api-client](https://github.com/Bloggify/c-sharp-api-client) - A command line Bloggify API client written in C#.
* [Bitl/hl2ac_launcher](https://github.com/Bitl/hl2ac_launcher) - C# launcher for Half-Life 2 Survivor. Built with Sharp Develop.
* [Autoro/SharpCommand](https://github.com/Autoro/SharpCommand) - A light-weight input binding system that is easily extendable to any input capturing library.
* [zinkpad/SharpCifs](https://github.com/zinkpad/SharpCifs) - SharpCifs is a port of JCIFS to C#
* [ydanila/sharpen_imazen_config](https://github.com/ydanila/sharpen_imazen_config) - This repository contains separate config project for the sharpen_imazen
* [yaroncon/c-sharp-http-client](https://github.com/yaroncon/c-sharp-http-client) - Automatically exported from code.google.com/p/c-sharp-http-client
* [wipau/Patmat-v1.2-Chess-C-Sharp](https://github.com/wipau/Patmat-v1.2-Chess-C-Sharp) - iki yıl önce c# ile yazmış olduğum iki kişilik satranç oyunu
* [winch/winch.pinkbile.com-c-sharp](https://github.com/winch/winch.pinkbile.com-c-sharp) - winch.pinkbile.com C# projects
* [wfarr/telepathy-mission-control-sharp](https://github.com/wfarr/telepathy-mission-control-sharp) - Mono C# bindings for libmissioncontrol
* [voiceittech/voiceit-c-sharp](https://github.com/voiceittech/voiceit-c-sharp) - C# wrapper for VoiceIt voice biometrics API
* [vim-scripts/sharp-Syntax](https://github.com/vim-scripts/sharp-Syntax) - Syntax for C# 2.0 (keywords: C-sharp, C sharp, CSharp)
* [veljus/Binary-search-tree-C-Sharp](https://github.com/veljus/Binary-search-tree-C-Sharp) - Complete binary search tree with full functionality
* [vaggabond/LearningCSharp](https://github.com/vaggabond/LearningCSharp) - Learning C Sharp Stuff
* [utneon/Visual-Studio-C-Sharp-Academic-Project-3--Windows-Forms-Application-Serialization](https://github.com/utneon/Visual-Studio-C-Sharp-Academic-Project-3--Windows-Forms-Application-Serialization) - Visual C# Windows Forms Application - Skill Level: Advanced. I developed this Visual Studio C# console application project for C# programming language course. The objective given by the teacher was to build a multimedia library application similiar to the first project developed as a console application but using Windows Forms Applicaiton this time. I also added by myself serialization for saving data to a binary file instead of just plain text.
* [utneon/Visual-Studio-C-Sharp-Academic-Project-1--Console-Application](https://github.com/utneon/Visual-Studio-C-Sharp-Academic-Project-1--Console-Application) - Visual C# Console Application - Skill Level: Beginner. The application is a simulation of a multimedia library for Movies, Music and Pictures with rental system. It doesn't make sense to rent pictures and files, but this was for academic purposes as it was asked for the entire class. View the README.txt for more information about the project.
* [urielzen/C_Sharp_Movie_Database_Singleton_Full_App](https://github.com/urielzen/C_Sharp_Movie_Database_Singleton_Full_App) - A movie review database using Singleton pattern. It has the ability to see movie details in a separate webpage and add reviews with a 1 to 5 rating system.
* [unixarcade/Txt-to-C-](https://github.com/unixarcade/Txt-to-C-) - Text to C Sharp
...
* [tristan-reeves/SharpConfig](https://github.com/tristan-reeves/SharpConfig) - Easy configuration
* [treblih/dip](https://github.com/treblih/dip) - Deprecated !! simple digital processing tool written in C, multi-algorithms for smooth & sharp and so forth
* [tphx/StreamChatSharp](https://github.com/tphx/StreamChatSharp) - A C# library designed specifically for use with the Twitch.tv IRC chat service.
* [tlazaro/SharpChess](https://github.com/tlazaro/SharpChess) - OOP assignment for UCU
* [tillberg/mbta](https://github.com/tillberg/mbta) - A C-Sharp rewrite of the generator for tillberg.us/mbta
* [the-s-a-m/c-sharp_route_planner](https://github.com/the-s-a-m/c-sharp_route_planner) - Route planer for modul ecnf c# based
* [tgmayfield/svn-clean-sharp](https://github.com/tgmayfield/svn-clean-sharp) - svn-clean written in C#
* [svoloshyn/sudoku_by_cb_sharp](https://github.com/svoloshyn/sudoku_by_cb_sharp) - Windows version of Sudoku game. See online version at http://sudoku.org.ua/
* [svizion/CodeSharp](https://github.com/svizion/CodeSharp) - A CodeIgniter-based CMS
* [sunilpottumuttu/SharpCleverbot](https://github.com/sunilpottumuttu/SharpCleverbot) - A CSharp wrapper over the Cleverbot API
* [stormbreakerbg/C-Sharp-expression-parser](https://github.com/stormbreakerbg/C-Sharp-expression-parser) - Parses expressions in infix notation and evaluates them. Works with math, logical (boolean) expressions and any other. You define the operators and the functions.
* [sreeshprakash/C_Sharp](https://github.com/sreeshprakash/C_Sharp) - My C# projects
* [sqm/sharp_aquos_remote_control](https://github.com/sqm/sharp_aquos_remote_control) - Gem for adding Sharp Aquos Remote Control functionality with Ruby.
* [sorrentmutie/SharpComicVine](https://github.com/sorrentmutie/SharpComicVine) - A C# LIbrary to connect to the ComicVine API
* [shivercube/C-Sharp_Application_Classes](https://github.com/shivercube/C-Sharp_Application_Classes) - Base application classes which can ease development for C# console and WPF applications
* [sheressa/SharpDevelop4.3_Source_Code](https://github.com/sheressa/SharpDevelop4.3_Source_Code) - Código Fuente del IDE SharpDevelop 4.3
* [shawty/CefSharpExample](https://github.com/shawty/CefSharpExample) - Example project for my .NET Nuts and bolts post on CefSharp
* [sharp/sharp_chinamap](https://github.com/sharp/sharp_chinamap) - Add auto scroll view feature  for your iOS project
* [sgp15/RestSharpCall](https://github.com/sgp15/RestSharpCall) - Basic Rest Sharp Call to get a response
* [seyekuyinu/SharpChat](https://github.com/seyekuyinu/SharpChat) - An app that allows friends to share time-bound pictures...just like snapchat
* [sebastienjouhans/c-sharp-listbox-snap-control](https://github.com/sebastienjouhans/c-sharp-listbox-snap-control) - Windows Phone 8 (WP8) listbox with snap (vertical scroll only)
* [sebastienjouhans/c-sharp-arduino-service](https://github.com/sebastienjouhans/c-sharp-arduino-service) - simple service which allow communication with arduino over USB (serial port)
* [sdurko/c-sharp](https://github.com/sdurko/c-sharp) - My shared code from interview tests and other fun stuff
* [sdmunoz9/ocho-reinas](https://github.com/sdmunoz9/ocho-reinas) - Juego de las ocho reinas portado de Java y Visual Basic a C-Sharp
* [rwoloszyn/ceeSharp](https://github.com/rwoloszyn/ceeSharp) - Projekty związane z C# oraz Windows Phone 7
* [rpalaniappan/FuzzySharp](https://github.com/rpalaniappan/FuzzySharp) - C Sharp library to work with fuzzy
* [ronnieoverby/CefSharpTest](https://github.com/ronnieoverby/CefSharpTest) - testing cefsharp3 webview for wpf
* [rlreis90/cmd-sharp](https://github.com/rlreis90/cmd-sharp) - Small library and tools for unix-style program composition, through a reactive programming model.
* [richardspiers/Sharp-IMS-Client](https://github.com/richardspiers/Sharp-IMS-Client) - Basic IMS Client written in C#
* [returnzork/C-Sharp-minecraft-server-backup](https://github.com/returnzork/C-Sharp-minecraft-server-backup) - A minecraft server backup program, written in C#, to copy your world to a backup directory.
* [returnzork/C-Sharp-MC-Server-Backup-V2](https://github.com/returnzork/C-Sharp-MC-Server-Backup-V2) - Version2 of my backup project
* [renhualu/tsccui32](https://github.com/renhualu/tsccui32) - traffic signal controller c sharp userinterface 32phase
* [rbmiguel/c-sharp-jcertd](https://github.com/rbmiguel/c-sharp-jcertd) - JcertD
* [ramandeep-bakshi/Simple-Web-Browser-C-Sharp](https://github.com/ramandeep-bakshi/Simple-Web-Browser-C-Sharp) - A simple web-browser with basic functionality coded in C#
* [rajeshsurana/C-Sharp-.Net-Portfolio](https://github.com/rajeshsurana/C-Sharp-.Net-Portfolio) - Cool C# Projects!
* [radyalabs/Windows-C_Sharp-Coding-Style](https://github.com/radyalabs/Windows-C_Sharp-Coding-Style) - Radya Labs C# Coding Style for Windows Phone and Windows Store
* [programingBYyui/sample_of_c_sharp](https://github.com/programingBYyui/sample_of_c_sharp) - this project is maybe sample charp.
* [pmn/planetcsharp](https://github.com/pmn/planetcsharp) - Planet C Sharp source
* [pld-linux/dotnet-gdata-sharp](https://github.com/pld-linux/dotnet-gdata-sharp) - gdata-sharp - C# library that makes it easy to access data through Google Data APIs
* [pete312/C-Sharp-Demo](https://github.com/pete312/C-Sharp-Demo) - Demos that show programming in C#
* [pauledavey/CodeSharper.PowerPoint.Helper](https://github.com/pauledavey/CodeSharper.PowerPoint.Helper) - A Helper library to make using PowerPoint in c# easier!
* [pangratz/scharfer-vogel](https://github.com/pangratz/scharfer-vogel) - c-sharp twitter client
* [openrasta/openrasta-codecs-sharpview](https://github.com/openrasta/openrasta-codecs-sharpview) - The SharpView template engine, to build HTML in C#
* [nopcodex90/Mp3Player](https://github.com/nopcodex90/Mp3Player) - A Basic mp3 player in C sharp
* [nankezhishi/SharpCloudStorage](https://github.com/nankezhishi/SharpCloudStorage) - A C# wrapper to cloud storage platform. Such as grandcloud and alicloud
* [n3zorian/C-Sharp](https://github.com/n3zorian/C-Sharp) - C sharp projects
* [myitweb/ASP.NET-with-C-Sharp](https://github.com/myitweb/ASP.NET-with-C-Sharp) - BSc IT Semester 5 Practicals | ASP.NET with C# | Mumbai University
* [mono/cocoa-sharp](https://github.com/mono/cocoa-sharp) - Deprecated: old bindings to the Cocoa API.   Use MonoMac instead.
* [mndrake/IfSharp.Charting](https://github.com/mndrake/IfSharp.Charting) - charting library for IfSharp using MetricsGraphics.js
* [mkirbst/cworker](https://github.com/mkirbst/cworker) - duplicate-finder for windows in c sharp
* [mimeoconnect/Mimeo-Connect-Cloud-Print-API-C-Sharp-Libraries](https://github.com/mimeoconnect/Mimeo-Connect-Cloud-Print-API-C-Sharp-Libraries) - These are the C Sharp / C# libraries for the Mimeo Connect Cloud Print API
* [mikerandrup/PaperRockScissorsLizardSpock_cSharp](https://github.com/mikerandrup/PaperRockScissorsLizardSpock_cSharp) - C# Class (complete with overloaded comparison operators) for Paper Rock Scissors Lizard Spock
* [mikef5410/NXP_DFU](https://github.com/mikef5410/NXP_DFU) - Update an NXP LPC43xx microcontroller with USB-DFU. C-sharp dot-net code compiles with Mono and LibUsbDotNet
* [memokoko/Mini-C-Sharp-Compiler](https://github.com/memokoko/Mini-C-Sharp-Compiler) - X86 compiler and simple IDE for c# language developed as university project.
* [meetri/hello-c-sharp](https://github.com/meetri/hello-c-sharp) - jp and db learning c sharp
* [mcliment/Sharp2City](https://github.com/mcliment/Sharp2City) - Imported from Sharp2City Codeplex project
* [matthewsot/CocoaSharp](https://github.com/matthewsot/CocoaSharp) - C# stubs for Cocoa and CocoaTouch
* [matt-richardson/ReSharper.ComGuidChecker](https://github.com/matt-richardson/ReSharper.ComGuidChecker) - Provides resharper problem analysis to check that the COM guid specified at an assembly level is unique.
* [malaker/C-Sharp](https://github.com/malaker/C-Sharp) - Programs written in C#
* [mabaer/intro_c_sharp](https://github.com/mabaer/intro_c_sharp) - This project includes demo projects for an introduction workshop to c# for students with programming background.
* [maate/BarCodeSharp](https://github.com/maate/BarCodeSharp) - Recognize bar codes from C# and other .NET languages.
* [luigiberrettini/c-sharp-basics](https://github.com/luigiberrettini/c-sharp-basics) - Learn C# basics with sample code
* [lonewolfwilliams/dinkyDSP](https://github.com/lonewolfwilliams/dinkyDSP) - Small, simple and extensible real-time audio synthesis framework for Unity4 written in c-sharp
* [lizaamini/CSharpExercises](https://github.com/lizaamini/CSharpExercises) - Solutions for all C Sharp exercises for AS Computer Science
* [leezhm/CSnippets](https://github.com/leezhm/CSnippets) - C Sharp Snippets for learning
* [laoling/C-sharp-note-StepByStep](https://github.com/laoling/C-sharp-note-StepByStep) - 我这个月开始学习一门新的编程语言，C#，进入微软独家语言的学习，此仓库是对学习进度的一个保存。
* [kwnetzwelt/mono_scaling](https://github.com/kwnetzwelt/mono_scaling) - Provides software scaling algorithms for textures and images for mono, c-sharp complete with Unity3D integration.
* [kurtjcu/Crestron.SimpleSharp.RMC3-EISC-TV](https://github.com/kurtjcu/Crestron.SimpleSharp.RMC3-EISC-TV) - This Project is a simple EISC controlled RMC3 that turns a samsung screen On/off, as well as switching from HDMI1 to HDMI2 Via RS232.
* [krystianity/ceka-cli](https://github.com/krystianity/ceka-cli) - CekaCli - Command Line Interface Application for Ceka Data Mining Library in C Sharp
* [krystianity/ceka](https://github.com/krystianity/ceka) - Ceka - Data Mining Library in C Sharp
* [kkarner708/cSharp-Text-Based-Game](https://github.com/kkarner708/cSharp-Text-Based-Game) - (unfinished) using visual studio
* [kepplemr/cSharpWIC](https://github.com/kepplemr/cSharpWIC) - Interpreter for Wren Intermediate Code written in C#
* [jurkov/Steganographie-cSharp](https://github.com/jurkov/Steganographie-cSharp) - Steganographie Example
* [jrote1/VirtualBoxControlCSharp](https://github.com/jrote1/VirtualBoxControlCSharp) - A C Sharp Class Library that allows you to control VirtualBox
* [joydevfinomial/C-Sharp-Tunning](https://github.com/joydevfinomial/C-Sharp-Tunning) - Demo C# Tune
* [jojojames/Xamarin-AndroidAsync-Binding](https://github.com/jojojames/Xamarin-AndroidAsync-Binding) - C# binding for https://github.com/koush/AndroidAsync, adapted from https://github.com/thefactory/AndroidAsync-Sharp
* [joemaddalone/vbSharpControl](https://github.com/joemaddalone/vbSharpControl) - vbSharp is a collection of ASP.NET shortcuts
* [joelcnz/C-Sharp-Bombs-and-Craters](https://github.com/joelcnz/C-Sharp-Bombs-and-Craters) - Falling bombs making craters
* [joaocarvalhoopen/WAV_Tools_C_Sharp](https://github.com/joaocarvalhoopen/WAV_Tools_C_Sharp) - Audio WAV file tools for C# read and write, 8 and 16 bits, mono and stereo.
* [joanbarros/SharpConfig](https://github.com/joanbarros/SharpConfig) - Configuration library for C#
* [jimpoulakos/c-sharp-statistics-library](https://github.com/jimpoulakos/c-sharp-statistics-library) - A Simple C# Statistics Library
* [jemzlee4/CardSharp](https://github.com/jemzlee4/CardSharp) - RCOS Card Counting Library
* [jcoddaire/C-Sharp-Code](https://github.com/jcoddaire/C-Sharp-Code) - This contains various snippets of C sharp code.
* [jawaidmcs550/C-Sharp-Library](https://github.com/jawaidmcs550/C-Sharp-Library) - This is a C# code Library you can save your C# code here
* [jasonmw/f-sharp-string-calculator](https://github.com/jasonmw/f-sharp-string-calculator) - F# String Calculator
* [ivpusic/Edward-company-cSharp-app](https://github.com/ivpusic/Edward-company-cSharp-app) - Application for Edward d.o.o. company. Application use ORM to acces data (LINQ)
* [inthefabric/FabricSharpClient](https://github.com/inthefabric/FabricSharpClient) - The official, fluent Fabric API client (for .NET/C#).
* [imnomit/Chadwick--the-Scientific-Pencil-Sharpener](https://github.com/imnomit/Chadwick--the-Scientific-Pencil-Sharpener) - Chadwick, the Scientific Pencil Sharpener, is a highly intelligent, slightly rude Asian genius capable of relaying the grade 9 science semester in a single, summarized, user-friendly fashion.
* [idiot000/C-Sharp-Practice](https://github.com/idiot000/C-Sharp-Practice) - Random C# code snippets
* [hkdobrev/softuni-c-sharp-basics-exam](https://github.com/hkdobrev/softuni-c-sharp-basics-exam) - My solutions of the C# Basics exam - April 2014
* [hirokgreen/store-procedure-to-dynamic-C-sharp-Form](https://github.com/hirokgreen/store-procedure-to-dynamic-C-sharp-Form) - store procedure to dynamic C# Form programmatically
* [haspeleo/dotNETDev](https://github.com/haspeleo/dotNETDev) - C sharp and .Net programming
* [guronutf8/c_sharp](https://github.com/guronutf8/c_sharp) - Резозиторий для тестов
* [grozeille/sonar-plugin-dotnet](https://github.com/grozeille/sonar-plugin-dotnet) - C-Sharp Plugins for Sonar
* [gqy117/RestSharp.Configuration](https://github.com/gqy117/RestSharp.Configuration) - Read request information from a har file, and create a new RestRequest();
* [gotson/c-sharp-inifiles](https://github.com/gotson/c-sharp-inifiles) - A library to easily read/write INI files
* [fidellio369/AssetManager](https://github.com/fidellio369/AssetManager) - asset manager c sharp and wcf business app
* [fferegrino/that-c-sharp-guy](https://github.com/fferegrino/that-c-sharp-guy) - New blog. Cool.
* [fferegrino/cool-sharp](https://github.com/fferegrino/cool-sharp) - Otra guía de estilo cool para C#
* [felipebortoli/Teste-cSharp](https://github.com/felipebortoli/Teste-cSharp) - teste
* [fahadash/ConsoleSharp](https://github.com/fahadash/ConsoleSharp) - Command Line Helper for .NET, Written in C#
* [ewencluley/Space1939](https://github.com/ewencluley/Space1939) - Space 1939 - a game written in C Sharp and XNA 4.0.  This was written towards the end of my 2nd year of my degree (April 2011) and showcases use of XNA to create a 3D game from scratch.  Techniques that were used include 3D modelling, particle effects, music and dynamic sound, mesh construction from a height map and much more.
* [elpikel/sharp_koans](https://github.com/elpikel/sharp_koans) - konas for c sharp
* [elpikel/sharp_katas](https://github.com/elpikel/sharp_katas) - c_sharp_katas
* [elkdanger/ChameleonSharp](https://github.com/elkdanger/ChameleonSharp) - A set of project templates and ScriptSharp dependencies, for creating new Widgets for Chameleon.
* [eliprand/PostSharp-NoCoNetUG](https://github.com/eliprand/PostSharp-NoCoNetUG) - Examples and samples about my presentation to the Northern Colorado .NET User Group in April 2015
* [dylian94/K8055-C-Sharp-Wrapper](https://github.com/dylian94/K8055-C-Sharp-Wrapper) - A C# Wrapper for the Velleman K8055 DLL
* [dtopalov/C-Sharp-OOP](https://github.com/dtopalov/C-Sharp-OOP) - Homeworks and other tasks for the course C#OOP
* [drawers/sir-linq-a-lot-cSharp](https://github.com/drawers/sir-linq-a-lot-cSharp) - A C# console app to perform sorting/joining etc. on JSON and XML data. Uses functional programming style via Linq.
* [doubleday/cocos-sharp-sandbox](https://github.com/doubleday/cocos-sharp-sandbox) - Scratch pad for CocosSharp
* [dbaker3/head-first-c-sharp](https://github.com/dbaker3/head-first-c-sharp) - Lessons from Head First C# book
* [davedx/simple-c-sharp-http-client](https://github.com/davedx/simple-c-sharp-http-client) - An extremely stripped down HTTP client that does not use System.Web for use in Unity iOS projects
* [danielcdcj/DHDB](https://github.com/danielcdcj/DHDB) - Simple database manager written in c-sharp
* [cuken/SharpBot-CLI](https://github.com/cuken/SharpBot-CLI) - First Development Commit
* [cstrahan/cstrahan-lib-sharp](https://github.com/cstrahan/cstrahan-lib-sharp) - My c# libraries.
* [creatic-pw/SharpCMF](https://github.com/creatic-pw/SharpCMF) - Content Management Framework (Apache License Software)
* [cotazz/enterpriseframeworksB](https://github.com/cotazz/enterpriseframeworksB) - c sharp project
* [colincapurso/CeliaSharp](https://github.com/colincapurso/CeliaSharp) - C# rebuild of Celia game
* [coder369/C-Sharp](https://github.com/coder369/C-Sharp) - C# API wrapper
* [codelucas/puzzles](https://github.com/codelucas/puzzles) - Gotta stay sharp! Common algorithms and puzzles implemented in C, Java, and Python.
* [codebutler/glade-sharp-code-generator](https://github.com/codebutler/glade-sharp-code-generator) - Automatically generate code in any Mono language from glade files.
* [codeathon/C-Sharp-Application](https://github.com/codeathon/C-Sharp-Application) - This is a simple C# Calculator Application
* [cloudeolive/cdo_sdk_c_sharp](https://github.com/cloudeolive/cdo_sdk_c_sharp) - C# Bindings to the Cloudeo SDK
* [cbovar/ConvNetSharp](https://github.com/cbovar/ConvNetSharp) - C# port of ConvNetJS
* [cardpay/c-sharp-api](https://github.com/cardpay/c-sharp-api) - The Cardpay SDK for C# enables access to Cardpays's API functionality on C# platform.
* [bryanthankins/CheatSharp](https://github.com/bryanthankins/CheatSharp) - Port of RubyGem Cheats into C# for native windows use
* [bradhelm/Matrix-C-Sharp](https://github.com/bradhelm/Matrix-C-Sharp) - Simple Matrix Class for .NET with Source Code in C#
* [batas2/PdfSharp.Controls](https://github.com/batas2/PdfSharp.Controls) - Set of UI controlrs for PdfSharp lib. Controls in WinForms style. Sample, generating VAT-UE2 document.
* [badman814/c-sharp](https://github.com/badman814/c-sharp) - code samples
* [aukgit/Object-Oriented-Programming-with-C-Sharp](https://github.com/aukgit/Object-Oriented-Programming-with-C-Sharp) - Object Oriented Programming with C#
* [askehill/test_repo2](https://github.com/askehill/test_repo2) - c sharp stuff
* [ashmoran/c-sharp-test-framework](https://github.com/ashmoran/c-sharp-test-framework) - A me-too test framework to help me learn C#
* [arturo182/C-Sharp-Bomberman](https://github.com/arturo182/C-Sharp-Bomberman) - A project for my Component Programming class.
* [arttuladhar/C_Sharp_Dot_Net](https://github.com/arttuladhar/C_Sharp_Dot_Net) - Source Code on C Sharp Dot Net Project
* [annasbd/Xat](https://github.com/annasbd/Xat) - Little chat applicattion in c sharp for TCP and threads learning for my students
* [albertvoskamp/Learn-C-sharp](https://github.com/albertvoskamp/Learn-C-sharp) - Repo to support learning C-sharp
* [akhurst/CSharp4Demo](https://github.com/akhurst/CSharp4Demo) - C Sharp 4 Demo
* [akfish/CoffeeSharp](https://github.com/akfish/CoffeeSharp) - A CoffeeScript compiler targeting .Net DLR
* [ada0006/cSharp-Test](https://github.com/ada0006/cSharp-Test) - skarede kody ktere me uci psat ve skole :'(
* [abame/eCommerce-C-sharp](https://github.com/abame/eCommerce-C-sharp) - eCommerce-C-sharp for OOP2 subject - school project
* [Zeokat/Publish-on-Twitter-OAuth-API-C-Sharp](https://github.com/Zeokat/Publish-on-Twitter-OAuth-API-C-Sharp) - Como publicar en Twitter empleando la API y la autenticación OAuth mediante un programa en C#
* [Zagitta/CrazySharp](https://github.com/Zagitta/CrazySharp) - C# client library for the crazyflie quadcopter
* [YaKalmar/CSCalculator](https://github.com/YaKalmar/CSCalculator) - Calculator on c sharp.
* [WASasquatch/humhub-themes-thermalcore](https://github.com/WASasquatch/humhub-themes-thermalcore) - A dark, sharp orange theme for HumHub by WAS (Jordan S. C. Thompson)
* [VolatileMindsLLC/cuckoo-sharp](https://github.com/VolatileMindsLLC/cuckoo-sharp) - cuckoo-sandbox bindings in C#
* [VolatileMindsLLC/clam-sharp](https://github.com/VolatileMindsLLC/clam-sharp) - C# bindings to both libclamav and clamd
* [Virus-X/CoinSharp](https://github.com/Virus-X/CoinSharp) - Bitcoin client library for .NET platform. Based on BitcoinSharp and BitcoinJ
* [UgurKaan/Turkce-Kelime-Duzeltme-ve-Kok-Bulma-Programi--C-Sharp-Zemberek-Kutuphanesi](https://github.com/UgurKaan/Turkce-Kelime-Duzeltme-ve-Kok-Bulma-Programi--C-Sharp-Zemberek-Kutuphanesi) - Sosyal Medya Analizi projesi içerisinde kullanmak amacıyla Zemberek Kütüphanesi yardımıyla geliştirdiğim kelime düzeltme ve kök bulma programı.
* [Tryan18/C-Sharp](https://github.com/Tryan18/C-Sharp) - C# Projects that I created in the past. Designed for beginner programmers and students.
* [T145/sharpen-configs](https://github.com/T145/sharpen-configs) - A small collection of configuration files for sharpen!
* [Srivatsa6065/UCTypeRegistration](https://github.com/Srivatsa6065/UCTypeRegistration) - http://srivatsaprasad.com/c-sharp/unity-container-register-type-convention/
* [SondaSengupta/SandwichMaker](https://github.com/SondaSengupta/SandwichMaker) - Serves you a Sandwich randomly. Enter mood if you wish. A study in C Sharp arrays.
* [SharpHelper/SharpHelper.Client](https://github.com/SharpHelper/SharpHelper.Client) - LeagueSharp Healper
* [SharpCraft/SharpCraft](https://github.com/SharpCraft/SharpCraft) - Sitio oficial de SharpCraft Factions en GitHub. - Web: http://sharpcraftfactions.enjin.com/
* [SharpConnect/SharpConnect.MySql](https://github.com/SharpConnect/SharpConnect.MySql) -  MIT license, MySQL Connector / MySQL Driver for .NET, ported from node-mysql
* [SharpCLABot/SharpCLABot](https://github.com/SharpCLABot/SharpCLABot) - A bot to manage Contributor License Agreement for your github projects
* [Shane-McCarthy/Bubble-Sort-C-Sharp](https://github.com/Shane-McCarthy/Bubble-Sort-C-Sharp) - Complete Bubble sort coded from scratch.
* [SCodeDevs/c-sharp-proj](https://github.com/SCodeDevs/c-sharp-proj) - My projects in C Sharp
* [Robin2009/CefSharpDemo](https://github.com/Robin2009/CefSharpDemo) - CefSharp+WinForm+AngularJs+TypeScript
* [Rizal-Afani/crud-c-sharp-oracle](https://github.com/Rizal-Afani/crud-c-sharp-oracle) - Contoh aplikasi CRUD c# - oracle
* [Rizal-Afani/c-sharp-sms-sender](https://github.com/Rizal-Afani/c-sharp-sms-sender) - Aplikasi SMS Gateway (Sender) dengan C# untuk layanan sms info di MIN SOBO Banyuwangi
* [RalphGreNader/Old-C-Sharp-Projects](https://github.com/RalphGreNader/Old-C-Sharp-Projects) - These are some old C# applications I made.
* [Radfordhound/Sonic-Sharp](https://github.com/Radfordhound/Sonic-Sharp) - SoniC# (Pronounced "Sonic Sharp") is an open-source engine based off of the brilliant games in the Sonic the Hedgehog franchise written in C# with MonoGame. SoniC# is designed to be flexible and easy-to-use, while still being as close to the original game's physics as possible.
* [QuickbaseAdmirer/QuickBase-C-Sharp-SDK](https://github.com/QuickbaseAdmirer/QuickBase-C-Sharp-SDK) - C# wrapper for Intuit QuickBase HTTP APIs
* [PsHegger/CivSharp.WheatleyScience](https://github.com/PsHegger/CivSharp.WheatleyScience) - This is the source of WhetleyScience's code used at WTW 2012
* [OptimalPayments/c-sharp_SDK](https://github.com/OptimalPayments/c-sharp_SDK) - Optimal Payments c-sharp SDK
* [NightFox2870/OOTechniekenYahtzeeCSharp](https://github.com/NightFox2870/OOTechniekenYahtzeeCSharp) - Project OO Technieken C Sharp
* [NickStrupat/BrainfuckSharpCompiler](https://github.com/NickStrupat/BrainfuckSharpCompiler) - A brainfuck compiler written in C#. Compiles to an executable .NET assembly
* [Mathight/C_Sharp_sources](https://github.com/Mathight/C_Sharp_sources) - rep met allerlei source codes en projectren in C#
* [Linus-Boehm/Schiffbummer](https://github.com/Linus-Boehm/Schiffbummer) - Schiffeversenken in C# sharp für 2 Spieler
* [Kasu777/TravelTimeCS](https://github.com/Kasu777/TravelTimeCS) - Travel Time Implement with C Sharp
* [JoseMHR/C-Sharp-Examples](https://github.com/JoseMHR/C-Sharp-Examples) - C Sharp - Examples
* [JeongDongHwan/EQ-project-C-sharp-API](https://github.com/JeongDongHwan/EQ-project-C-sharp-API) - first
* [JZito/Unity-Synthesizer-in-C-Sharp](https://github.com/JZito/Unity-Synthesizer-in-C-Sharp) - A synthesizer written in C# utilizing Unity's OnAudioFilterRead method.
* [Imisnew2/C-Sharp-Voip-Manager-Teamspeak-3](https://github.com/Imisnew2/C-Sharp-Voip-Manager-Teamspeak-3) - A simple to use C# library that handles asynchronous and synchronous connections to a Teamspeak 3 server.
* [Hipmob/hipmob-c-sharp](https://github.com/Hipmob/hipmob-c-sharp) - Hipmob C# bindings
* [Fruckert/CharasSharp](https://github.com/Fruckert/CharasSharp) - A new Charas.ex implementation coded in C#
* [FObermaier/SharpMap.Rendering.Thematics.CategoryTheme](https://github.com/FObermaier/SharpMap.Rendering.Thematics.CategoryTheme) - A categorial theme for SharpMap
* [Computician/gst-sharp-precompiled](https://github.com/Computician/gst-sharp-precompiled) - This is a precompiled DLL for the gstreamer C# bindings. Glib-Sharp is included and the x86 and x64 gstreamer glue dll for 1.0
* [CodersUnited/C-Sharp](https://github.com/CodersUnited/C-Sharp) - C# Programming
* [CodeTherion/SharpCSV](https://github.com/CodeTherion/SharpCSV) - An entirely .NET expansive and flexible CSV Library!
* [CodeTag/cSharpBot](https://github.com/CodeTag/cSharpBot) - Bot Codetag Challenge C#
* [CDROn93/CSharpPractice](https://github.com/CDROn93/CSharpPractice) - C Sharp work
* [BrightLight/SharpCop](https://github.com/BrightLight/SharpCop) - ReSharper plugin that checks some FxCop rules
* [Blue4x4Rebel/nb-c-sharp](https://github.com/Blue4x4Rebel/nb-c-sharp) - NetBeans plugin for C-Sharp
* [BesuglovS/Dijkstra](https://github.com/BesuglovS/Dijkstra) - WinForms C sharp implementation of Dijkstra algorithm
* [Bakkes/demoinfogo-c-](https://github.com/Bakkes/demoinfogo-c-) - CSGO demo parsing in C Sharp
* [BabyJam/Learning-C-Sharp](https://github.com/BabyJam/Learning-C-Sharp) - Learnig to develop with C#
* [AtomicSource/copernicus-path](https://github.com/AtomicSource/copernicus-path) - C sharp
* [Asazeus/SharpForumChecker](https://github.com/Asazeus/SharpForumChecker) - forumChecker
* [AndreyShamis/Csharp-Math](https://github.com/AndreyShamis/Csharp-Math) - C SHARP Lib with Math algorithms
* [Aharobot/Subsumption](https://github.com/Aharobot/Subsumption) - Subsumption Architecture in C Sharp
* [Accusoft/ACS-C-Sharp-Viewing-Sample](https://github.com/Accusoft/ACS-C-Sharp-Viewing-Sample) - This is a C# sample for using Accusoft's Cloud Services to view a document. With trivial changes, the same sample can be used to view documents using Accusoft's Prizm Content Connect on-premises product.
* [AbdelazizAlrihawi/Ellomi](https://github.com/AbdelazizAlrihawi/Ellomi) - application to calculate the numerical integration in Simpson method in C Sharp
* [zhaoxiaochao/C_Sharp](https://github.com/zhaoxiaochao/C_Sharp) - C#
* [yooasd11/C-Sharp](https://github.com/yooasd11/C-Sharp) - C# practice
* [yastrov/C_Sharp](https://github.com/yastrov/C_Sharp) - C Sharp tips (Only for me:) )
* [xjunin/Desenvolvimento-CSharp](https://github.com/xjunin/Desenvolvimento-CSharp) - Desenvolvimento C# Sharp
* [xiaobing90/C-sharp](https://github.com/xiaobing90/C-sharp) - Designed Multi-thread trading platform on C# and .NET framework
* [wyjackey/C-Sharp](https://github.com/wyjackey/C-Sharp) - study how to use C Sharp
* [wpank/C-Sharp](https://github.com/wpank/C-Sharp) - Various excercises and projects written in C Sharp
* [wordtinker/c-sharp](https://github.com/wordtinker/c-sharp) - Bunch of C-sharp exercises
* [willyscv/csharp](https://github.com/willyscv/csharp) - C sharp code developmenet
* [williamdnapier/c-sharp](https://github.com/williamdnapier/c-sharp) - Collection of snippets and recipes written in C#
* [weilanhai1/cSharp](https://github.com/weilanhai1/cSharp) - C#学习
* [websabio/cSharp](https://github.com/websabio/cSharp) - C# Development
* [walerek/c-sharp](https://github.com/walerek/c-sharp) - Small represitory for c# learning
* [vmNN/c-sharp](https://github.com/vmNN/c-sharp) - C# programmering
* [victorgan/csharpplayground](https://github.com/victorgan/csharpplayground) - learning c sharp
* [vickey1990/Csharp-Program](https://github.com/vickey1990/Csharp-Program) - Simple C sharp program
* [valdiney/C_sharp](https://github.com/valdiney/C_sharp) - Aprendendo C#
* [usingthecode/c.sharp](https://github.com/usingthecode/c.sharp) - Opensource repo for everything C#
* [unimesh/algos](https://github.com/unimesh/algos) - c sharp algo development
* [twistedhawk/cSharp-pong](https://github.com/twistedhawk/cSharp-pong) - Simple pong game for c# with MonoGame framework
* [trymmm11/Csharp-learning](https://github.com/trymmm11/Csharp-learning) - Øving på C sharp
* [tonkaata/C-Sharp](https://github.com/tonkaata/C-Sharp) - Homeworks
* [tomyvarghese/C-Sharp](https://github.com/tomyvarghese/C-Sharp) - Sample Code in C-Sharp
* [tobiasfr82/c-sharp](https://github.com/tobiasfr82/c-sharp) - C# code snippets
* [themrsnk/C_Sharp](https://github.com/themrsnk/C_Sharp) - C# projects
* [teeder/squiggmud](https://github.com/teeder/squiggmud) - c sharp mud
* [techverze/c-sharp](https://github.com/techverze/c-sharp) - Techverze is trusted institute across the globe in delivering C# online training explain understanding and implementing C# language features with hands-on.  For More Details Click On Below Link: http://bit.ly/1S6V9L1
* [techtangle/C_Sharp](https://github.com/techtangle/C_Sharp) - C# projects
* [tavispa/csharp](https://github.com/tavispa/csharp) - C Sharp Practice Code
* [svetoslavpopov93/C-Sharp](https://github.com/svetoslavpopov93/C-Sharp) - All C# projects in one repository
* [suusitalo/C_sharp](https://github.com/suusitalo/C_sharp) - omat C# harkat
* [suryasnath/csharp](https://github.com/suryasnath/csharp) - c sharp
* [sturker/c.sharp](https://github.com/sturker/c.sharp) - Suleyman Demirel Üniversitesi Bilgisayar Programlama Dersi Örnekleri
* [stormbytes-official/C-Sharp](https://github.com/stormbytes-official/C-Sharp) - Tick to C-Sharp
* [stefanoz/C_Sharp_Projects](https://github.com/stefanoz/C_Sharp_Projects) - C_Sharp_Projects
* [sowmyachakrapani/delegate](https://github.com/sowmyachakrapani/delegate) - C sharp delegate examples
* [sowmyachakrapani/C-sharp](https://github.com/sowmyachakrapani/C-sharp) - Examples worked on and my notes
* [smatthews-cc/csharpcode](https://github.com/smatthews-cc/csharpcode) - c sharp coding assignments
* [smandekar1/VS15-C-](https://github.com/smandekar1/VS15-C-) - C Sharp files
* [slymnkbdyi/c-sharp](https://github.com/slymnkbdyi/c-sharp) - Calışma Ve Projeler
* [skirov/C-Sharp](https://github.com/skirov/C-Sharp) - C# Part 1, C# Part 2, C# OOP, Quality Programming Code, Data Structures and Algorithms
* [sanjaya1/C-Sharp](https://github.com/sanjaya1/C-Sharp) - A C Sharp repository
* [sammelnik/C-Sharp-example](https://github.com/sammelnik/C-Sharp-example) - C Sharp example
* [ruanpienaar/c_sharp](https://github.com/ruanpienaar/c_sharp) - Some C# learning ....
* [rosslight/csharpBase](https://github.com/rosslight/csharpBase) - c sharp base
* [robmarano/cSharpStarterApp](https://github.com/robmarano/cSharpStarterApp) - Starter application for my C# class at Cooper Union
* [rgrossen/C-Sharp-](https://github.com/rgrossen/C-Sharp-) - Password GUI
* [remzjohncarlo/cSharp](https://github.com/remzjohncarlo/cSharp) - c sharp code snippets
* [reggielancera/C-Sharp](https://github.com/reggielancera/C-Sharp) - C# tutorial
* [rahulahoop/cSharp](https://github.com/rahulahoop/cSharp) - messing around with c#
* [qkshan/c_sharp](https://github.com/qkshan/c_sharp) - for leaning c# program
* [pratibharawat/C-Sharp](https://github.com/pratibharawat/C-Sharp) - Learning C-Sharp. My code snippets as I try to get hands on the language.
* [potterhere/C-sharp](https://github.com/potterhere/C-sharp) - Learnings
* [plami/C-Sharp](https://github.com/plami/C-Sharp) - problems
* [piravinsat/C-Sharp](https://github.com/piravinsat/C-Sharp) - Work written in the C# programming language
* [phoenix2718/C_sharp](https://github.com/phoenix2718/C_sharp) - C# programming
* [pfred2/c_sharp](https://github.com/pfred2/c_sharp) - My c# projects
* [persianstarr/cSharp](https://github.com/persianstarr/cSharp) - C#
* [patiljignesh/C_Sharp](https://github.com/patiljignesh/C_Sharp) - Learning C# from scratch with basic programming.
* [pascal-chenevas/c-sharp](https://github.com/pascal-chenevas/c-sharp) - c-sharp
* [omeryaylaalti/C-Sharp](https://github.com/omeryaylaalti/C-Sharp) - C# Kod Çalışmalarım
* [notesforcsharpuniversity/calculate](https://github.com/notesforcsharpuniversity/calculate) - calculate on c sharp
* [nataviva/sharpdevelop](https://github.com/nataviva/sharpdevelop) - free c sharp compiler
* [natalkata/C_Sharp](https://github.com/natalkata/C_Sharp) - C#
* [nanananabatman/C--Adventure](https://github.com/nanananabatman/C--Adventure) - C-Sharp adventure game
* [murirene/cSharp](https://github.com/murirene/cSharp) - C Sharp Projects
* [mouldiwarp/c-sharp](https://github.com/mouldiwarp/c-sharp) - Repository for multiple C# development projects
* [monster57/Learn-C-](https://github.com/monster57/Learn-C-) - learning c sharp only
* [monoshade/C-Sharp](https://github.com/monoshade/C-Sharp) - Learning Notes
* [moBoston/cSharp](https://github.com/moBoston/cSharp) - cSharp
* [mmitin/Fibonacci-numbers](https://github.com/mmitin/Fibonacci-numbers) - c-sharp-code
* [mikkiemouse/C-sharp](https://github.com/mikkiemouse/C-sharp) - C-sharp
* [merrovingo/C-Sharp](https://github.com/merrovingo/C-Sharp) - Código y proyectos de C#
* [maxtoroq/XCST](https://github.com/maxtoroq/XCST) - eXtensible C-Sharp Templates
* [maslivak/cSharp](https://github.com/maslivak/cSharp) - Testando C#
* [marianina8/c_sharp](https://github.com/marianina8/c_sharp) - C# code
* [marcasselin/AsyncLib2](https://github.com/marcasselin/AsyncLib2) - C Sharp Async Lib
* [manojadams/Learning-c-sharp](https://github.com/manojadams/Learning-c-sharp) - learning c sharp
* [mahilion/C-sharp](https://github.com/mahilion/C-sharp) - assignment1
* [madip/MagnetGolf](https://github.com/madip/MagnetGolf) - c sharp projekt
* [macwilly/cSharp](https://github.com/macwilly/cSharp) - In class work for client side programing
* [lohkii69/C-Sharp-Repository](https://github.com/lohkii69/C-Sharp-Repository) - C Sharp Projects
* [linyihan/AutoUpdate](https://github.com/linyihan/AutoUpdate) - C Sharp AutoUpdate
* [leptonic/C_sharp](https://github.com/leptonic/C_sharp) - c# projects
* [lcristianiim/c-sharp](https://github.com/lcristianiim/c-sharp) - some s-sharp applications
* [knagieknagger/Csharp](https://github.com/knagieknagger/Csharp) - C sharp test repo
* [kisubkim/C_Sharp](https://github.com/kisubkim/C_Sharp) - C# Study
* [kevinguam/cSharp](https://github.com/kevinguam/cSharp) - Data Structure
* [kelleo/CSharpDev](https://github.com/kelleo/CSharpDev) - C sharp Development
* [kebarr/qwalk](https://github.com/kebarr/qwalk) - first c sharp code
* [kanisorn/c-sharp](https://github.com/kanisorn/c-sharp) - C# Sample code
* [jungyilin/C_sharp_test1](https://github.com/jungyilin/C_sharp_test1) - 03192014
* [jsonzhuo/c-sharp](https://github.com/jsonzhuo/c-sharp) - one world, one json
* [joelsinchej/cSharp](https://github.com/joelsinchej/cSharp) - Aplicaciones en Visual cSharp 2005 & 2012
* [jennyfurwhen/sharpDISH](https://github.com/jennyfurwhen/sharpDISH) - c sharp version
* [jean-pierreDuman/TP-C-sharp](https://github.com/jean-pierreDuman/TP-C-sharp) - TP-C-sharp
* [jdegalvez/C_Sharp](https://github.com/jdegalvez/C_Sharp) - All of my C# project
* [jasondubois/C-sharp](https://github.com/jasondubois/C-sharp) - C# files for school projects
* [james-k-polk/csharp](https://github.com/james-k-polk/csharp) - C sharp examples
* [jaimelara/C-Sharp](https://github.com/jaimelara/C-Sharp) - Ejercicios de C#
* [ivoiv8/C-Sharp-Projects](https://github.com/ivoiv8/C-Sharp-Projects) - C-Sharp-Projects
* [ivaka1510/C-Sharp](https://github.com/ivaka1510/C-Sharp) - C# problems
* [italeks/C-sharp](https://github.com/italeks/C-sharp) - C-sharp
* [ismaelares/interpreter](https://github.com/ismaelares/interpreter) - INTERPRETER C SHARP
* [iridii/C_Sharp_Code](https://github.com/iridii/C_Sharp_Code) - C_Sharp_Code
* [iguth3/C-Sharp](https://github.com/iguth3/C-Sharp) - C# Code
* [ifrahim/C-Sharp](https://github.com/ifrahim/C-Sharp) - Create PDF file using iTextsharp
* [ianheyi/CSharp](https://github.com/ianheyi/CSharp) - C sharp learning samples
* [hvivani/C-Sharp](https://github.com/hvivani/C-Sharp) - utilities developed in C#
* [huytrinh93/C-Sharp](https://github.com/huytrinh93/C-Sharp) - Code I built based on C#
* [hoihoi661/C-Sharp-Frogger](https://github.com/hoihoi661/C-Sharp-Frogger) - C-Sharp Assignment
* [hawkway/C_Sharp](https://github.com/hawkway/C_Sharp) - my C# projects
* [hasbisevinc/C_sharp](https://github.com/hasbisevinc/C_sharp) - Csharp Projects
* [guajiropa/C-Sharp](https://github.com/guajiropa/C-Sharp) - C Sharp programs
* [granthuu/c-sharp-learning](https://github.com/granthuu/c-sharp-learning) - c sharp learning
* [gps13/Coursera_C_Sharp](https://github.com/gps13/Coursera_C_Sharp) - Coursera - Beginning Game Programming with C#
* [gphenegar/C-sharp](https://github.com/gphenegar/C-sharp) - C Sharp applications
* [gotyuri/C-Sharp](https://github.com/gotyuri/C-Sharp) - C# Projects
* [goldensky/C-sharp](https://github.com/goldensky/C-sharp) - solving my C-sharp problems MSU
* [gjenczyk/cSharp](https://github.com/gjenczyk/cSharp) - Here are some miscellaneous c# programs I've written
* [gitpan/C-Sharp](https://github.com/gitpan/C-Sharp) - Read-only release history for C-Sharp
* [ghidalgor/C-Sharp](https://github.com/ghidalgor/C-Sharp) - I work with basic topics in C#.
* [ghbartlett/cSharp](https://github.com/ghbartlett/cSharp) - C Sharp Coding Examples
* [georgimanov/C-Sharp](https://github.com/georgimanov/C-Sharp) - C# - Lectures, HW, Games, Exams, SortingMethods ...
* [gary003/c_sharp](https://github.com/gary003/c_sharp) - c#
* [gangov/cSharp](https://github.com/gangov/cSharp) - C# - Intro to C# exercises
* [fullarray/C_Sharp](https://github.com/fullarray/C_Sharp) - C# projects
* [ftrcn/C-sharp](https://github.com/ftrcn/C-sharp) - C# ve ASP.NET dillerinin kodları mevcuttur.
* [filipverlee/csharp-2010-boek](https://github.com/filipverlee/csharp-2010-boek) - C Sharp boek - info
* [fawuahgyasi/C_Sharp](https://github.com/fawuahgyasi/C_Sharp) - Csharp codes
* [exploitx3/C-Sharp-](https://github.com/exploitx3/C-Sharp-) - C#
* [enymann/c-sharp](https://github.com/enymann/c-sharp) - cshtml
* [emilNikolov/Csharp](https://github.com/emilNikolov/Csharp) - excercises with C sharp
* [emaruca/cSharp](https://github.com/emaruca/cSharp) - Collection of c# code
* [elunim/C-Sharp](https://github.com/elunim/C-Sharp) - C Sharp docs
* [elbogi/MVC1](https://github.com/elbogi/MVC1) - C sharp prosjekt
* [efoco/C-Sharp](https://github.com/efoco/C-Sharp) - Updated 11/12/2013
* [edleyrocha/C-Sharp-SQL-Conections2015](https://github.com/edleyrocha/C-Sharp-SQL-Conections2015) - C-Sharp-SQL-Conections2015
* [edleyrocha/C-Sharp-Cryptography2015](https://github.com/edleyrocha/C-Sharp-Cryptography2015) - C-Sharp-Cryptography
* [ebcolab/c_sharp](https://github.com/ebcolab/c_sharp) - project c#
* [doddoindan/Pyatnashki](https://github.com/doddoindan/Pyatnashki) - first c_sharp project
* [dizzarg/lab_application](https://github.com/dizzarg/lab_application) - C sharp simple application
* [dirktall04/C_Sharp](https://github.com/dirktall04/C_Sharp) - C_Sharp projects for GIS Tasks
* [developbiao/C_sharp](https://github.com/developbiao/C_sharp) - C_sharp
* [dev-submail/SUBMAIL_C_SHARP_SDK](https://github.com/dev-submail/SUBMAIL_C_SHARP_SDK) - SUBMAIL_C_SHARP_SDK
* [dev-console/c-sharp](https://github.com/dev-console/c-sharp) - C#
* [david-myers-code/csharp-pig-game](https://github.com/david-myers-code/csharp-pig-game) - C Sharp pig game
* [dannygao/Twitter4Net](https://github.com/dannygao/Twitter4Net) - Twitter for C sharp
* [danielrobinsonwork/cSharp](https://github.com/danielrobinsonwork/cSharp) - My Work With c# programming language
* [daed5/c-Sharp](https://github.com/daed5/c-Sharp) - C#
* [cychmps426211/C_sharp](https://github.com/cychmps426211/C_sharp) - SysJust
* [crissyg/C-Sharp](https://github.com/crissyg/C-Sharp) - Beginner
* [crazyministr/C-Sharp](https://github.com/crazyministr/C-Sharp) - Some tasks written on the C#
* [cppshooter/Rancher](https://github.com/cppshooter/Rancher) - First C Sharp Demo
* [cooleymike/C-](https://github.com/cooleymike/C-) - C Sharp
* [compuram/CSharp](https://github.com/compuram/CSharp) - C Sharp Projects
* [cmplx11/c-sharp](https://github.com/cmplx11/c-sharp) - c#
* [clintcparker/c_sharp_testing](https://github.com/clintcparker/c_sharp_testing) - A sample application showing various testing methods
* [cidpas31/lycee_duprat](https://github.com/cidpas31/lycee_duprat) - appilcation_formation_c_sharp
* [chuckb23/C-sharp](https://github.com/chuckb23/C-sharp) - work done in C#
* [chrisjamhol/cSharp](https://github.com/chrisjamhol/cSharp) - c# leaning
* [chobitech/C-Sharp](https://github.com/chobitech/C-Sharp) - chobitech's C# projects
* [chhatrapati/C-sharp](https://github.com/chhatrapati/C-sharp) - C# example code to use Web Scrape Master API
* [ccmorataya/c-sharp](https://github.com/ccmorataya/c-sharp) - Ejemplos de C# utilizando Mono como compilador
* [c35573585/C_Sharp](https://github.com/c35573585/C_Sharp) - C#
* [byzod/C-Sharp](https://github.com/byzod/C-Sharp) - Microsoft Visual C#
* [byOrix/cSharp](https://github.com/byOrix/cSharp) - Research & Develop on C#
* [bsdshell/csharp](https://github.com/bsdshell/csharp) - c sharp
* [bilwis/CSRLBase](https://github.com/bilwis/CSRLBase) - C Sharp RogueLike Base
* [bhwithun/c-sharp](https://github.com/bhwithun/c-sharp) - Automatically exported from code.google.com/p/c-sharp
* [bengie6/csharp](https://github.com/bengie6/csharp) - C Sharp Projects
* [bekendici/c_sharp](https://github.com/bekendici/c_sharp) - moji radovi
* [barnesd/cSharp](https://github.com/barnesd/cSharp) - Contains exercises and code from Fundamentals of Computer Programming with C#
* [artinnok/C-Sharp](https://github.com/artinnok/C-Sharp) - 2011 (course of C Sharp)
* [arslanark/C-Sharp](https://github.com/arslanark/C-Sharp) - This repository contains small and random codes on different topics. These codes are of C# language and are written in Visual Studio Ultimate 2013
* [arronhyman/C-Sharp](https://github.com/arronhyman/C-Sharp) - C# .NET
* [applenob/r4cs](https://github.com/applenob/r4cs) - repository for c sharp
* [annapoluektova/cSharp](https://github.com/annapoluektova/cSharp) - c#
* [andyplusplus/C-Sharp](https://github.com/andyplusplus/C-Sharp) - C#
* [andriOlafsson/cSharp](https://github.com/andriOlafsson/cSharp) - Almennt fikt
* [amehna/cSharp](https://github.com/amehna/cSharp) - DotNet Applications at GlobSyn
* [alromav1120/C-sharp](https://github.com/alromav1120/C-sharp) - C sharp projects
* [alextenche/C-sharp](https://github.com/alextenche/C-sharp) - C-sharp and XNA small programs
* [alessandrorezende/C-Sharp](https://github.com/alessandrorezende/C-Sharp) - C# Codes
* [albertodiego/C-SHARP](https://github.com/albertodiego/C-SHARP) - PRACTICAS PROGRAMACION III
* [akoebr/C_Sharp_turorials](https://github.com/akoebr/C_Sharp_turorials) - C_Sharp_turorials
* [agilecrm/c-sharp-api](https://github.com/agilecrm/c-sharp-api) - .NET C# API for Agile
* [a66askhan/C-Sharp](https://github.com/a66askhan/C-Sharp) - C# Codes
* [Xiao-Future/C-Sharp](https://github.com/Xiao-Future/C-Sharp) - Learn the C#
* [XDRosenheim/C-Sharp](https://github.com/XDRosenheim/C-Sharp) - Anything I do in C#.
* [Writkas/VT--C-Sharp](https://github.com/Writkas/VT--C-Sharp) - Videos Tutoriales C Sharp
* [Wenchao21/C_sharp](https://github.com/Wenchao21/C_sharp) - Just test.
* [WC-GitHub/C-Sharp](https://github.com/WC-GitHub/C-Sharp) - C Sharp Description
* [Veselov-Dmitry/C-Sharp](https://github.com/Veselov-Dmitry/C-Sharp) - mylabs
* [Ubuntus/ENDigitNumbers](https://github.com/Ubuntus/ENDigitNumbers) - Learning c sharp
* [TrevorPearson/Zoom](https://github.com/TrevorPearson/Zoom) - Zoom with C sharp
* [TravisAvey/c-sharp](https://github.com/TravisAvey/c-sharp) - Time for another language to learn.  C#
* [ThreadbareConnor/Tutorial_Program](https://github.com/ThreadbareConnor/Tutorial_Program) - C Sharp Tutorial
* [Terminator-Aaron/CSharpLearn](https://github.com/Terminator-Aaron/CSharpLearn) - C Sharp Learn
* [SteveTheBot/CSharp](https://github.com/SteveTheBot/CSharp) - For c sharp
* [SpencerWie/C-Sharp](https://github.com/SpencerWie/C-Sharp) - C# and .NET applications
* [Shantanu3004/Dot-Net](https://github.com/Shantanu3004/Dot-Net) - C sharp code
* [SeemMoonMet/C-](https://github.com/SeemMoonMet/C-) - C Sharp
* [SOURO/C-Sharp](https://github.com/SOURO/C-Sharp) - MVC Application Demo - Simple Controller Action Sample
* [S-rajalakshmi/C-sharp](https://github.com/S-rajalakshmi/C-sharp) - C# and .net
* [Russel-dox/C_sharp](https://github.com/Russel-dox/C_sharp) - C# projects
* [Rafflesia-Khan/C_sharp](https://github.com/Rafflesia-Khan/C_sharp) - this repository is to hold my project work under my C# learning
* [PorcoChan/CSharpBase](https://github.com/PorcoChan/CSharpBase) - c sharp base code
* [PixzleOne/cSharp](https://github.com/PixzleOne/cSharp) - C sharp stuff I don´t get to work.
* [PhilBusko/C-Sharp](https://github.com/PhilBusko/C-Sharp) - All c-sharp projects
* [Pathoscross/-cs260-project](https://github.com/Pathoscross/-cs260-project) - C_sharp_paractice
* [PGeorgiev/C-Sharp](https://github.com/PGeorgiev/C-Sharp) - C# Part 1, C# Part 2, C# OOP, Quality Programming Code, Data Structures and Algorithms
* [Ourique/C-Sharp](https://github.com/Ourique/C-Sharp) - Projects in C Sharp language
* [OleksandrKL/c_sharp_examples](https://github.com/OleksandrKL/c_sharp_examples) - c sharp examples
* [Nic-Coons/C-Sharp](https://github.com/Nic-Coons/C-Sharp) - simple +-x/ calc
* [NagamaniKoganti/C-sharp](https://github.com/NagamaniKoganti/C-sharp) - Reusable Class Library for Windows & web
* [MrBalin/CSharpPractice](https://github.com/MrBalin/CSharpPractice) - Practicing my C Sharp!
* [MorSamochian/HITC14](https://github.com/MorSamochian/HITC14) - C sharp course
* [Momerath/C_Sharp](https://github.com/Momerath/C_Sharp) - C# software
* [ModdersCentral/c-sharp-litecoin-faucet](https://github.com/ModdersCentral/c-sharp-litecoin-faucet) - facuet for litecoin made in C#...
* [Misterthomas/C-Sharp](https://github.com/Misterthomas/C-Sharp) - C-Sharp projects
* [MaybeGitHub/cSharp](https://github.com/MaybeGitHub/cSharp) - .Net
* [MattMckeller/C_Sharp](https://github.com/MattMckeller/C_Sharp) - Visual C# modifying/deleting/adding and viewing information in databases with a simple application
* [MarcioRamos90/Calculadora](https://github.com/MarcioRamos90/Calculadora) - Calculadora c sharp
* [MHRY/Unity](https://github.com/MHRY/Unity) - C Sharp Scripting
* [Lidouh/c_sharp](https://github.com/Lidouh/c_sharp) - projet c_sharp
* [KunjeshBaghel/cSharp](https://github.com/KunjeshBaghel/cSharp) - Learning c#
* [Killo0o/Advanced-CSharp-Homework](https://github.com/Killo0o/Advanced-CSharp-Homework) - SoftUni C Sharp Homeworks
* [KevinLima/C-sharp](https://github.com/KevinLima/C-sharp) - Alle C# projecten van Kevin Lima
* [Kensaigm/ACM.Win](https://github.com/Kensaigm/ACM.Win) - Defensive Code C Sharp
* [Karasawa47/IntroToCSharp](https://github.com/Karasawa47/IntroToCSharp) - beginning c sharp
* [JunYan-Qu/c_sharp](https://github.com/JunYan-Qu/c_sharp) - c#
* [JoshuaVSherman/ChristmasBasketCsharp](https://github.com/JoshuaVSherman/ChristmasBasketCsharp) - original c sharp code
* [Jonicon/C_Sharp](https://github.com/Jonicon/C_Sharp) - A couple of exercises and one larger project.
* [JoeTriplett/C-Sharp](https://github.com/JoeTriplett/C-Sharp) - C-Sharp
* [JiriVasko/C-sharp](https://github.com/JiriVasko/C-sharp) - Programovací úkoly.
* [JediKnight/C-Sharp](https://github.com/JediKnight/C-Sharp) - しーしゃーぷ
* [Jason3206/MyProjects](https://github.com/Jason3206/MyProjects) - C-Sharp Dev
* [IvoTonchev1/C-Sharp](https://github.com/IvoTonchev1/C-Sharp) - C-Sharp Homeworks and Projects
* [IvayloNikolov/CSharp](https://github.com/IvayloNikolov/CSharp) - C Sharp Beginner
* [Iontchev/C_sharp_2_Homeworks](https://github.com/Iontchev/C_sharp_2_Homeworks) - C sharp 1 Homeworks
* [IonicaBizau/learning-c-sharp](https://github.com/IonicaBizau/learning-c-sharp) - This repository contains random applications written in C#.
* [IgorVictorovich/C-sharp](https://github.com/IgorVictorovich/C-sharp) - My code samples in C#
* [IbizaHerrero/C-Sharp](https://github.com/IbizaHerrero/C-Sharp) - Proyectos autodidactas programados en lenguaje C#Sharp.
* [IAmAnubhavSaini/csex](https://github.com/IAmAnubhavSaini/csex) - C Sharp Examples
* [Hailag/C_Sharp](https://github.com/Hailag/C_Sharp) - Study C#
* [HHDFUNBEIJING/study](https://github.com/HHDFUNBEIJING/study) - C sharp study
* [Govorspace/csharplesson](https://github.com/Govorspace/csharplesson) - C sharp - lesson
* [Golther/C-Sharp](https://github.com/Golther/C-Sharp) - Learning C#
* [Geiko/cSharp](https://github.com/Geiko/cSharp) - solutions
* [Gasour/C-Sharp](https://github.com/Gasour/C-Sharp) - C#
* [Flexusaurs/c_sharp](https://github.com/Flexusaurs/c_sharp) - c# test
* [FallenAngelX/C-sharp](https://github.com/FallenAngelX/C-sharp) - C sharp stuff for school
* [EzequielAyzenberg/GestionDeDatos](https://github.com/EzequielAyzenberg/GestionDeDatos) - Repo de C Sharp
* [EqLogic/C-Sharp-For-RunUO](https://github.com/EqLogic/C-Sharp-For-RunUO) - Miscellaneous C# addons for the RunUO & Ulmeta platforms.
* [Edgardo-Santana/C-SHARP](https://github.com/Edgardo-Santana/C-SHARP) - Carpeta de proyectos, segmentos de codigos programados en C-SHARP
* [Donderstone2/C-Sharp](https://github.com/Donderstone2/C-Sharp) - Project
* [DmitryVSidorov/traineeship](https://github.com/DmitryVSidorov/traineeship) - C-sharp traineeship
* [DmitryFilippow/C_Sharp](https://github.com/DmitryFilippow/C_Sharp) - C# projects
* [Dexterleslie/csgamblespider](https://github.com/Dexterleslie/csgamblespider) - c sharp gamble spider
* [DestinyMobile/C-Sharp](https://github.com/DestinyMobile/C-Sharp) - Soluciones Web con C# MVC 5
* [DeedB/ABC](https://github.com/DeedB/ABC) - C_Sharp_Advanced_Tutorials
* [DanLippold/CSharp2](https://github.com/DanLippold/CSharp2) - C Sharp Commander 2
* [DaleHogan/C_Sharp](https://github.com/DaleHogan/C_Sharp) - Collection of C# examples
* [Cup-of-Cocoa/CSharp](https://github.com/Cup-of-Cocoa/CSharp) - C Sharp Training
* [CristianAleman/C-Sharp](https://github.com/CristianAleman/C-Sharp) - GUI apps in C# language
* [Couraga/C-Sharp](https://github.com/Couraga/C-Sharp) - C-Sharp programmering på Linnéuniversitetet
* [CodeLookBook/C-sharp](https://github.com/CodeLookBook/C-sharp) - Homeworks and personal projects that were made using the C# language
* [ChrstphrR/C-sharp](https://github.com/ChrstphrR/C-sharp) - Haven for C# code, while I poke away to learn how things work here...
* [ChrisPizzo8600/C-Sharp-stuff](https://github.com/ChrisPizzo8600/C-Sharp-stuff) - C Sharp projects
* [ChrisPaine/C-sharp](https://github.com/ChrisPaine/C-sharp) - Code Library
* [Chengxiaozhi/C-Sharp](https://github.com/Chengxiaozhi/C-Sharp) - C sharp 常用小软件
* [Calo10/C-Sharp](https://github.com/Calo10/C-Sharp) - Codes for C Sharp
* [Bryanli910/C-Sharp](https://github.com/Bryanli910/C-Sharp) - My C# assignments, mostly dealing with financial data
* [Bojidar-At/C-Sharp](https://github.com/Bojidar-At/C-Sharp) - My Homework for C# Basic
* [BloodingKnight/C-Sharp](https://github.com/BloodingKnight/C-Sharp) - My repository using to study C#.
* [BillStorms/cSharp](https://github.com/BillStorms/cSharp) - cSharp programs
* [BiSmart/C-Sharp](https://github.com/BiSmart/C-Sharp) - code in C#
* [BerimboloEnterprises/CSHARPAlgorithms](https://github.com/BerimboloEnterprises/CSHARPAlgorithms) - Stack Implementataion C Sharp
* [AvraamMavridis/C_Sharp](https://github.com/AvraamMavridis/C_Sharp) - Various c# mini projects
* [Avans/ReCompiler](https://github.com/Avans/ReCompiler) - Recompiling C Sharp code
* [Asull715/C-Sharp](https://github.com/Asull715/C-Sharp) - Some of my work in C#!
* [Anubis-Black/C-Sharp](https://github.com/Anubis-Black/C-Sharp) - Telerik Academy Code
* [Antroid/C_Sharp](https://github.com/Antroid/C_Sharp) - Contains all toolchain and project written in C#
* [AlexBu/mob123](https://github.com/AlexBu/mob123) - practice for c sharp
* [Albemuth84/C_sharp](https://github.com/Albemuth84/C_sharp) - C# Projects (Not including Unity3D)
