...
* [justcoding121/Titanium-Web-Proxy](https://github.com/justcoding121/Titanium-Web-Proxy) - A cross platform, asynchronous proxy server in C#
...
* [rafaelfgx/DotNetArchitecture](https://github.com/rafaelfgx/DotNetArchitecture) - Architecture cross-platform with .NET Core 2.1.1, ASP.NET Core 2.1.1, Entity Framework Core 2.1.1, C#, Angular 6, DDD, SOLID, Code Analysis and others best practices and technologies.
...
* [sqlkata/querybuilder](https://github.com/sqlkata/querybuilder) - SQL query builder, written in c#, helps you build complex queries easily, supports SqlServer, MySql and PostgreSql
...
* [tylike/CIIP](https://github.com/tylike/CIIP) - CIIP用于快速开发ERP类信息系统的框架
...
* [vivet/GoogleApi](https://github.com/vivet/GoogleApi) - C# .NET Core Google Api (Maps, Places, Roads, Search, Translate). 100% support for all endpoints and requests / responses.
