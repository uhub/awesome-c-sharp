...
* [rafaelfgx/DotNetArchitecture](https://github.com/rafaelfgx/DotNetArchitecture) - Architecture cross-platform with .NET Core 2.1, ASP.NET Core 2.1, Entity Framework Core 2.1, C#, Angular 6, DDD, SOLID, Code Analysis and others best practices and technologies.
...
* [0xE8551CCB/serial-assistant](https://github.com/0xE8551CCB/serial-assistant) - 一款使用 C# 及 WPF 框架编写的串口调试助手，界面优雅、简洁，易于使用。
