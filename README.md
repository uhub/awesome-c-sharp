...
* [vovgou/loxodon-framework](https://github.com/vovgou/loxodon-framework) - An MVVM framework that can use C# and Lua to develop games
...
* [sipsorcery/sipsorcery](https://github.com/sipsorcery/sipsorcery) - A cross platform pure C# .NET Core library for SIP, VoIP and WebRTC. No native library wrappers required.
