...
* [Number Duck](https://github.com/NumberDuck/NumberDuck-CPlusPlus) - A C# library for developers to read and write Microsoft Excel compatible (.xls/.xlsx) spreadsheets.