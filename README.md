...
* [Number Duck](https://github.com/NumberDuck/NumberDuck-CSharp) - A C# library for developers to read and write Microsoft Excel compatible (.xls/.xlsx) spreadsheets.